...
(() => {
            ...
            return (function (t, e) {
              ...
              for (n = 0; n < h; n++)
                if ('string' == typeof t[n]) g += t[n];
                  ...
                  if (
                    (i.not_type.test(s.type) && i.not_primitive.test(s.type) && r instanceof Function && (r = r()),
                  ...
                  i.json.test(s.type)
                    ? (g += r)
                    : (!i.number.test(s.type) || (c && !s.sign) ? (f = '') : ((f = c ? '+' : '-'), (r = r.toString().replace(i.sign, ''))),
  ...
  (() => {
      ...
      function a() {
        ...
        t: for (; s; ) {
          if (s.args.length === arguments.length) {
            ...
            return (
              s !== r &&
                (s === n && (n = s.prev), (s.prev.next = s.next), s.next && (s.next.prev = s.prev), (s.next = r), (s.prev = null), (r.prev = s), (r = s)),
              s.val
            );
          }
          s = s.next;
    ...
    var o, s, l, u;
    (o = { '(': 9, '!': 8, '*': 7, '/': 7, '%': 7, '+': 6, '-': 6, '<': 5, '<=': 5, '>': 5, '>=': 5, '==': 4, '!=': 4, '&&': 3, '||': 2, '?': 1, '?:': 1 }),
      (s = ['(', '?']),
      (l = { ')': ['('], ':': ['?', '?:'] }),
      (u = /<=|>=|==|!=|&&|\|\||\?:|\(|!|\*|\/|%|\+|-|<|>|\?|\)|:/);
    var p = {
    ...
    (d.prototype.getPluralForm = function (t, e) {
      ...
      return (
        a ||
          ('function' != typeof (i = (r = this.data[t][''])['Plural-Forms'] || r['plural-forms'] || r.plural_forms) &&
            ((n = (function (t) {
              var e, r, n;
      ...
      (d.prototype.dcnpgettext = function (t, e, r, n, i) {
        ...
        return (
          ...
          (s = this.data[t][o]) && s[a] ? s[a] : (this.options.onMissingKey && this.options.onMissingKey(r, t), 0 === a ? r : n)
        );
      });
      ...
      x = (t, e, r) => {
        ...
        return {
          ...
          addLocaleData: (t, e = 'default') => {
            (n.data[e] = { ...n.data[e], ...t, '': { ...h, ...n.data[e]?.[''], ...t?.[''] } }), delete n.pluralForms[e], a();
          },
          resetLocaleData: (t, e) => {
          ...
          _nx: (t, e, n, i, a) => {
            let o = l(a, i, t, e, n);
            return r
              ? ((o = r.applyFilters('i18n.ngettext_with_context', o, t, e, n, i, a)), r.applyFilters('i18n.ngettext_with_context_' + u(a), o, t, e, n, i, a))
              : o;
          },
