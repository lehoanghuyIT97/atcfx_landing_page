...
!(function (n, t) {
  ...
  function rt(o) {
    return function (n, t, r) {
      t = S(t, r);
      for (var e = g(n), u = 0 < o ? 0 : e - 1; 0 <= u && u < e; u += o) if (t(n[u], u, n)) return u;
      return -1;
    };
  }
  var et = rt(1),
  ...
  n = Ft({
    ...
    template: function (o, n, t) {
      ...
      var r,
        t = RegExp([(n.escape || Wn).source, (n.interpolate || Wn).source, (n.evaluate || Wn).source].join('|') + '|$', 'g'),
        i = 0,
        a = "__p+='";
      if (
    ...
    throttle: function (r, e, u) {
      ...
      function n() {
        ...
        return (
          ...
          (f = arguments),
          t <= 0 || e < t
            ? (i && (clearTimeout(i), (i = null)), (l = n), (c = r.apply(a, f)), i || (a = f = null))
