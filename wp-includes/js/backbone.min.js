...
!(function (n) {
  ...
  function a(t, e, i, n, s) {
    ...
    } else if (i && l.test(i)) for (r = i.split(l); o < r.length; o++) e = t(e, r[o], n, s);
    else e = t(e, i, n, s);
    return e;
  }
  function x(t, e, i) {
  ...
  var o,
    ...
    n =
      ((e.on = function (t, e, i) {
        return (
          (this._events = a(n, this._events || {}, t, e, { context: i, ctx: this, listening: o })),
    ...
    r =
      ((e.off = function (t, e, i) {
        return this._events && (this._events = a(r, this._events, t, e, { context: i, listeners: this._listeners })), this;
      }),
    ...
    v =
      ...
      (g.prototype.off = function (t, e) {
        t = this.interop
          ? ((this._events = a(r, this._events, t, e, { context: void 0, listeners: void 0 })), !this._events)
      ...
      (b.extend(v.prototype, e, {
        ...
        set: function (t, e, i) {
          if (null != t) {
            ...
            if (!a) {
              if (!t) for (; this._pending; ) (i = this._pending), (this._pending = !1), this.trigger('change', this, i);
        ...
        url: function () {
          var t,
            e = b.result(this, 'urlRoot') || b.result(this.collection, 'url') || M();
        ...
        _validate: function (t, e) {
          ...
          return !t || (this.trigger('invalid', this, t, b.extend(e, { validationError: t })), !1);
        },
      }),
    ...
    y =
      (b.extend(m.prototype, e, {
        ...
        remove: function (t, e) {
          ...
          return !e.silent && t.length && ((e.changes = { added: [], merged: [], removed: t }), this.trigger('update', this, e)), i ? t[0] : t;
        },
        set: function (t, e) {
          if (null != t) {
            ...
            for (
              var i = !b.isArray(t),
                ...
                s = ((n = (n = null != n ? +n : n) > this.length ? this.length : n) < 0 && (n += this.length + 1), []),
                r = [],
                o = [],
                h = [],
                a = {},
              ...
              _
                ? (l &&
                    m !== _ &&
                    ((v = this._isModel(m) ? m.attributes : m), e.parse && (v = _.parse(v, e)), _.set(v, e), o.push(_), f) &&
                    !d &&
                    (d = _.hasChanged(p)),
                  a[_.cid] || ((a[_.cid] = !0), s.push(_)),
                  (t[g] = _))
                : u && (m = t[g] = this._prepareModel(m, e)) && (r.push(m), this._addReference(m, e), (a[m.cid] = !0), s.push(m));
            }
            if (c) {
            ...
            if (
              (s.length && !f && u && c
                ...
                : r.length && (f && (d = !0), x(this.models, r, null == n ? this.length : n), (this.length = this.models.length)),
              d && this.sort({ silent: !0 }),
              !e.silent)
            ) {
              for (g = 0; g < r.length; g++) null != n && (e.index = n + g), (m = r[g]).trigger('add', m, this, e);
              (d || y) && this.trigger('sort', this, e),
                (r.length || h.length || o.length) && ((e.changes = { added: r, removed: h, merged: o }), this.trigger('update', this, e));
            }
            return i ? t[0] : t;
          }
        },
        reset: function (t, e) {
          ...
          return (e.previousModels = this.models), this._reset(), (t = this.add(t, b.extend({ silent: !0 }, e))), e.silent || this.trigger('reset', this, e), t;
        },
        push: function (t, e) {
        ...
        _prepareModel: function (t, e) {
          return this._isModel(t)
            ...
            : (t = ((e = e ? b.clone(e) : {}).collection = this).model.prototype ? new this.model(t, e) : this.model(t, e)).validationError
        ...
        if (this._collection) {
          ...
          if (this._index < this._collection.length)
            return (
              ...
              this._index++,
              { value: this._kind === S ? t : ((e = this._collection.modelId(t.attributes, t.idAttribute)), this._kind === I ? e : [e, t]), done: !1 }
            );
    ...
    H =
      ...
      (h.sync = function (t, e, n) {
        var i,
          s = H[t],
          r = (b.defaults((n = n || {}), { emulateHTTP: h.emulateHTTP, emulateJSON: h.emulateJSON }), { type: s, dataType: 'json' }),
          o =
            (n.url || (r.url = b.result(e, 'url') || M()),
            null != n.data ||
              !e ||
              ('create' !== t && 'update' !== t && 'patch' !== t) ||
              ((r.contentType = 'application/json'), (r.data = JSON.stringify(n.attrs || e.toJSON(n)))),
            n.emulateJSON && ((r.contentType = 'application/x-www-form-urlencoded'), (r.data = r.data ? { model: r.data } : {})),
            !n.emulateHTTP ||
            ...
            if (((this.fragment = n), this._usePushState)) this.history[e.replace ? 'replaceState' : 'pushState']({}, document.title, i);
              ...
              this._updateHash(this.location, t, e.replace),
                this.iframe &&
                  ...
                  ((n = this.iframe.contentWindow), e.replace || (n.document.open(), n.document.close()), this._updateHash(n.location, t, e.replace));
            }
