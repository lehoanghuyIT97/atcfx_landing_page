                        ...
                        function () {
                          return 1 === (arguments.length <= 0 ? void 0 : arguments[0])
                            ? arguments.length <= 1
                              ...
                              : arguments[1]
                            : 0 === (arguments.length <= 0 ? void 0 : arguments[0]) ||
                                (0 < (arguments.length <= 0 ? void 0 : arguments[0]) % 100 && (arguments.length <= 0 ? void 0 : arguments[0]) % 100 < 20)
                              ? arguments.length <= 2
                                ? void 0
                                : arguments[2]
                              : arguments.length <= 3
                        ...
                        function () {
                          return 1 === (arguments.length <= 0 ? void 0 : arguments[0])
                            ? arguments.length <= 1
                              ...
                              : arguments[1]
                            : 0 === (arguments.length <= 0 ? void 0 : arguments[0]) ||
                                (1 < (arguments.length <= 0 ? void 0 : arguments[0]) % 100 && (arguments.length <= 0 ? void 0 : arguments[0]) % 100 < 11)
                              ? arguments.length <= 2
                                ? void 0
                                : arguments[2]
      ...
      function (e, t, n) {
        ...
        var i = function e(t, n, o) {
          ...
          var i = t,
            r = !1;
          if (
            ('string' == typeof t ? (f.mediaElement.originalNode = j.default.getElementById(t)) : (i = (f.mediaElement.originalNode = t).id),
          ...
          (f.mediaElement.id = i),
            ...
            (f.mediaElement.changeRenderer = function (e, t) {
              ...
              void 0 !== n.mediaElement.renderer &&
                ...
                (n.mediaElement.renderer.pause(), n.mediaElement.renderer.stop && n.mediaElement.renderer.stop(), n.mediaElement.renderer.hide());
            ...
            x = function (e) {
              if ('src' !== e) {
                var t = '' + e.substring(0, 1).toUpperCase() + e.substring(1),
                  n = function () {
                    return void 0 !== f.mediaElement.renderer && null !== f.mediaElement.renderer && 'function' == typeof f.mediaElement.renderer['get' + t]
            ...
            P = function (e) {
              ...
              if (
                (f.mediaElement.paused ||
                  ...
                  '' === f.mediaElement.src ||
                  (f.mediaElement.pause(), (c = (0, M.createEvent)('pause', f.mediaElement)), f.mediaElement.dispatchEvent(c)),
              ...
              if (n.isVideo) {
                ...
                if (
                  ...
                  n.globalBind(m.FULLSCREEN_EVENT_NAME, function () {
                    n.isFullScreen &&
                      (m.isFullScreen() ? ((n.isNativeFullScreen = !0), n.setControlsSize()) : ((n.isNativeFullScreen = !1), n.exitFullScreen()));
                  });
                }
              }
            },
              ...
              if (e.isVideo) {
                if (
                  ...
                  for (var r = e.getElement(e.layers).children, a = r.length, s = 0; s < a; s++)
                    (r[s].style.width = e.normalWidth + 'px'), (r[s].style.height = e.normalHeight + 'px');
                }
                e.fullscreenBtn &&
            ...
            buildprogress: function (h, s, e, d) {
              ...
              var i = function (e) {
                        ...
                        : void 0 !== t.mozTransform
                          ...
                          : void 0 !== t.oTransform
                            ...
                            : void 0 !== t.msTransform
                              ...
                              : 'transform',
                    r =
                      'WebKitCSSMatrix' in window ? 'WebKitCSSMatrix' : 'MSCSSMatrix' in window ? 'MSCSSMatrix' : 'CSSMatrix' in window ? 'CSSMatrix' : void 0,
                    a = 0,
                    s = 0,
                    l = 0,
                    d = void 0;
                  if (
                    ...
                    if (
                      ...
                      if ((l < 0 && (l = 0), g.options.useSmoothHover && null !== r && void 0 !== window[r])) {
                        ...
                        (g.hovered.style.left = u + 'px'),
                          ...
                          0 <= c ? (0, b.removeClass)(g.hovered, 'negative') : (0, b.addClass)(g.hovered, 'negative');
                      }
                      if (g.timefloat) {
                        ...
                        (s = d - p.left < g.timefloat.offsetWidth ? f : d - p.left >= g.getElement(g.container).offsetWidth - f ? g.total.offsetWidth - f : l),
                          (0, b.hasClass)(g.getElement(g.container), g.options.classPrefix + 'long-video') &&
                    ...
                    y.IS_IOS ||
                      y.IS_ANDROID ||
                      !g.timefloat ||
                      ((s = g.timefloat.offsetWidth + o >= g.getElement(g.container).offsetWidth ? g.timefloat.offsetWidth / 2 : 0),
                      (g.timefloat.style.left = s + 'px'),
                      (g.timefloat.style.left = s + 'px'),
                      (g.timefloat.style.display = 'block'));
                },
                    ...
                    if (((g.forcedHandlePause = !1), g.getDuration() !== 1 / 0 && (1 === e.which || 0 === e.which))) {
                      ...
                      g.globalBind('mouseup.dur touchend.dur', function () {
                        v &&
                          null !== g.getCurrentTime() &&
                          g.newTime.toFixed(4) !== g.getCurrentTime().toFixed(4) &&
                          (g.setCurrentTime(g.newTime), g.setCurrentRailHandle(g.newTime), g.updateCurrent(g.newTime)),
              ...
              g.slider.addEventListener('mouseenter', function (e) {
                e.target === g.slider &&
                  ...
                  g.hovered && !y.IS_IOS && !y.IS_ANDROID && g.options.useSmoothHover && (0, b.removeClass)(g.hovered, 'no-hover'));
              }),
                g.slider.addEventListener('mouseleave', function () {
                  g.getDuration() !== 1 / 0 &&
                    (v ||
                      (g.timefloat && (g.timefloat.style.display = 'none'), g.hovered && g.options.useSmoothHover && (0, b.addClass)(g.hovered, 'no-hover')));
                }),
                ...
                if (e.total && e.handle) {
                  ...
                  if (
                    ...
                    (e.hovered.style.left = r + 'px'),
                      ...
                      0 <= s ? (0, b.removeClass)(e.hovered, 'negative') : (0, b.addClass)(e.hovered, 'negative');
                  }
                }
              }
            },
            ...
            buildduration: function (e, t, n, o) {
              ...
              if (t.lastChild.querySelector('.' + i.options.classPrefix + 'currenttime'))
                ...
                t.querySelector('.' + i.options.classPrefix + 'currenttime') &&
                  (0, l.addClass)(t.querySelector('.' + i.options.classPrefix + 'currenttime').parentNode, i.options.classPrefix + 'currenttime-container');
      ...
      function (e, t, n) {
        ...
        Object.assign(o.config, {
            ...
            buildtracks: function (o, e, t, n) {
              if ((this.findTracks(), o.tracks.length || (o.trackFiles && 0 !== !o.trackFiles.length))) {
                  ...
                  o.tracks[c].src.trim() &&
                    ('subtitles' === f || 'captions' === f
                      ...
                      : 'chapters' !== f ||
                        ...
                        o.captionsButton.parentNode.insertBefore(o.chaptersButton, o.captionsButton));
                }
                ...
                if (i.options.toggleCaptionsButtonWhenOnlyOne && 1 === u)
                  ...
                  for (
                    var g = o.captionsButton.querySelectorAll('.' + i.options.classPrefix + 'captions-selector-label'),
                ...
                for (var k = 0, _ = h.length; k < _; k++)
                  o.chaptersButton.addEventListener(h[k], function () {
                    this.querySelector('.' + i.options.classPrefix + 'chapters-selector-list').children.length &&
                      (0, I.removeClass)(this.querySelector('.' + i.options.classPrefix + 'chapters-selector'), i.options.classPrefix + 'offscreen');
                  });
                ...
                o.chaptersButton.addEventListener('keydown', function (e) {
                  ...
                  o.options.alwaysShowControls
                    ? (0, I.addClass)(
                        o.getElement(o.container).querySelector('.' + i.options.classPrefix + 'captions-position'),
            ...
            setTrack: function (e, t) {
              ...
              if ('none' === e) (n.selectedTrack = null), (0, I.removeClass)(n.captionsButton, n.options.classPrefix + 'captions-enabled');
                ...
                for (var p = 0, m = n.tracks.length; p < m; p++) {
                  var h = n.tracks[p];
                  if (h.trackId === e) {
                    null === n.selectedTrack && (0, I.addClass)(n.captionsButton, n.options.classPrefix + 'captions-enabled'),
                      (n.selectedTrack = h),
            ...
            loadTrack: function (e) {
              ...
              void 0 === n ||
                ...
                (0, I.ajax)(
                  ...
                  function (e) {
                    (n.entries =
                      'string' == typeof e && /<tt\s+xml/gi.exec(e) ? d.default.TrackFormatParser.dfxp.parse(e) : d.default.TrackFormatParser.webvtt.parse(e)),
                      (n.isLoaded = !0),
              ...
              if (void 0 !== this.tracks) {
                ...
                if (null !== t && t.isLoaded) {
                  ...
                  if (-1 < n) {
                    ...
                    return (
                      'function' == typeof e.options.captionTextPreprocessor && (o = e.options.captionTextPreprocessor(o)),
              ...
              if (t) {
                ...
                for (
                  var o = r.chaptersButton.querySelectorAll('input[type="radio"]'),
                    i = r.chaptersButton.querySelectorAll('.' + r.options.classPrefix + 'chapters-selector-label'),
                    a = 0,
                    s = o.length;
                  a < s;
                  a++
                  ...
                  (o[a].disabled = !1),
                    ...
                    o[a].addEventListener('click', function (e) {
                      ...
                      (this.checked = !0),
                        ...
                        (0, I.removeClass)(
                          r.chaptersButton.querySelector('.' + r.options.classPrefix + 'chapters-selected'),
          ...
          (d.default.TrackFormatParser = {
                ...
                for (var t = e.split(/\r?\n/), n = [], o = void 0, i = void 0, r = void 0, a = 0, s = t.length; a < s; a++) {
                  if ((o = this.pattern.exec(t[a])) && a < t.length) {
                    ...
                    (i =
                      ...
                      n.push({
                        identifier: r,
                        start: 0 === (0, m.convertSMPTEtoSeconds)(o[1]) ? 0.2 : (0, m.convertSMPTEtoSeconds)(o[1]),
            ...
            dfxp: {
              parse: function (e) {
                var t = L.default.adoptNode(new DOMParser().parseFromString(e, 'application/xml').documentElement).querySelector('div'),
                ...
                for (var d = 0, u = n.length; d < u; d++) {
                  ...
                  if (
                    (n[d].getAttribute('begin') && (f.start = (0, m.convertSMPTEtoSeconds)(n[d].getAttribute('begin'))),
                    !f.start && n[d - 1].getAttribute('end') && (f.start = (0, m.convertSMPTEtoSeconds)(n[d - 1].getAttribute('end'))),
                    n[d].getAttribute('end') && (f.stop = (0, m.convertSMPTEtoSeconds)(n[d].getAttribute('end'))),
                    !f.stop && n[d + 1].getAttribute('begin') && (f.stop = (0, m.convertSMPTEtoSeconds)(n[d + 1].getAttribute('begin'))),
                    r)
                  )
              ...
              if ((!P.IS_ANDROID && !P.IS_IOS) || !this.options.hideVolumeOnTouchDevices) {
                ...
                var c = !1,
                  ...
                  y = function (e) {
                    if (null !== e && !isNaN(e) && void 0 !== e) {
                      ...
                      'vertical' === s
                        ? ((v.style.bottom = 0), (v.style.height = o), (g.style.bottom = o), (g.style.marginBottom = -parseFloat(i.height) / 2 + 'px'))
                        : ((v.style.left = 0), (v.style.width = o), (g.style.left = o), (g.style.marginLeft = -parseFloat(i.width) / 2 + 'px'));
                    }
                  },
                  E = function (e) {
                    var t = (0, C.offset)(h),
                  ...
                  b = function () {
                    a.muted
                      ? (y(0), (0, C.removeClass)(d, a.options.classPrefix + 'mute'), (0, C.addClass)(d, a.options.classPrefix + 'unmute'))
                      : (y(o.volume), (0, C.removeClass)(d, a.options.classPrefix + 'unmute'), (0, C.addClass)(d, a.options.classPrefix + 'mute'));
                  };
                e.getElement(e.container).addEventListener('keydown', function (e) {
                  ...
                  d.addEventListener('focusout', function (e) {
                    (e.relatedTarget && (!e.relatedTarget || e.relatedTarget.matches('.' + a.options.classPrefix + 'volume-slider'))) ||
                      'vertical' !== s ||
                    ...
                    E(e),
                      a.globalBind('mousemove.vol', function (e) {
                        ...
                        c &&
                          (t === m ||
                            t.closest(
                              'vertical' === s ? '.' + a.options.classPrefix + 'volume-slider' : '.' + a.options.classPrefix + 'horizontal-volume-slider'
                            )) &&
                          E(e);
                      }),
                ...
                o.addEventListener('rendererready', function () {
                  ...
                  (0 === e.options.startVolume || o.originalNode.muted) && (o.setMuted(!0), 0 === e.options.startVolume && (e.options.startVolume = 0), b()),
            ...
            o(r, [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (
                    ...
                    n.node.setAttribute('controls', !0), w.IS_IPAD && n.node.getAttribute('autoplay') && n.play();
                  else if (
                    (!n.isVideo && (n.isVideo || (!n.options.features.length && !n.options.useDefaultControls))) ||
                    ...
                    if (
                      ...
                      (n.getElement(n.container).className =
                        n.options.classPrefix + 'container ' + n.options.classPrefix + 'container-keyboard-inactive ' + n.media.className),
                      ...
                      n.isVideo &&
                        ...
                        !P.hasClass(n.getElement(n.container).parentNode, n.options.classPrefix + 'fill-container'))
                    ) {
                    ...
                    0 < n.options[a + 'Width'] || -1 < n.options[a + 'Width'].toString().indexOf('%')
                      ...
                      0 < n.options[a + 'Height'] || -1 < n.options[a + 'Height'].toString().indexOf('%')
                  ...
                  if (((e = void 0 === e || e), !i.controlsAreVisible && i.isVideo)) {
                    if (e)
                      ...
                      for (var t = i.getElement(i.container).querySelectorAll('.' + i.options.classPrefix + 'control'), n = 0, o = t.length; n < o; n++)
                        P.removeClass(t[n], i.options.classPrefix + 'offscreen'), (t[n].style.display = '');
                  ...
                  if (
                    ...
                    !0 === t ||
                      !(
                        ...
                        (i.paused &&
                          4 === i.readyState &&
                          ((!i.options.hideVideoControlsOnLoad && i.currentTime <= 0) || (!i.options.hideVideoControlsOnPause && 0 < i.currentTime))) ||
                    ...
                    if (e)
                      ...
                      for (var n = i.getElement(i.container).querySelectorAll('.' + i.options.classPrefix + 'control'), o = 0, r = n.length; o < r; o++)
                        P.addClass(n[o], i.options.classPrefix + 'offscreen'), (n[o].style.display = '');
              ...
              },
              {
                ...
                value: function (e, t) {
                  var n = this,
                    ...
                    i = !(null == o || 'false' === o),
                    r = null !== e.rendererName && /(native|html5)/i.test(e.rendererName);
                  if (
                    ...
                    if (
                      ...
                      n.getElement(n.container).dispatchEvent(s),
                        ...
                        n.media.addEventListener('loadedmetadata', function () {
                          (0, c.calculateTimeFormat)(n.getDuration(), n.options, n.options.framesPerSecond || 25),
                    ...
                    i && r && n.play(),
                      n.options.success &&
                        ('string' == typeof n.options.success ? S.default[n.options.success](n.media, n.domNode, n) : n.options.success(n.media, n.domNode, n));
                  }
                },
              },
              {
                ...
                value: function (e, t, n) {
                  ...
                  if (!a) {
                    ...
                    if (
                      (l && (s = '<img src="' + l + '" alt="' + f.default.i18n.t('mejs.download-file') + '">'),
                      ...
                      for (var d = 0, u = e.urls.length; d < u; d++) {
                        var c = e.urls[d];
                        a +=
                          '<a href="' + c.src + '" data-type="' + c.type + '"><span>' + f.default.i18n.t('mejs.download-file') + ': ' + c.src + '</span></a>';
                      }
                  }
                  a &&
              ...
              },
              {
                ...
                value: function () {
                  var o = this,
                    ...
                    t = e ? getComputedStyle(e, null) : getComputedStyle(x.default.body, null),
                    n = o.isVideo
                  ...
                  if (
                    ...
                    0 < o.getElement(o.container).parentNode.length &&
                      ...
                      ((l = S.default.innerWidth || x.default.documentElement.clientWidth || x.default.body.clientWidth),
                      (s = S.default.innerHeight || x.default.documentElement.clientHeight || x.default.body.clientHeight)),
                    s && l)
                  ) {
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  if (t.getElement(t.container)) {
                    ...
                    n ||
                      (((n = x.default.createElement('div')).className = t.options.classPrefix + 'poster ' + t.options.classPrefix + 'layer'),
                      t.getElement(t.layers).appendChild(n));
                    var o = n.querySelector('img');
                    !o &&
                      e &&
                      (((o = x.default.createElement('img')).className = t.options.classPrefix + 'poster-img'),
                      (o.width = '100%'),
                      (o.height = '100%'),
                      (n.style.display = ''),
                      n.appendChild(o)),
              ...
              },
              {
                ...
                value: function (e, t, n, o) {
                  ...
                  '' !== e.options.poster && (a && w.IS_IOS && o.originalNode.removeAttribute('poster'), (a = e.options.poster)),
                    a
                      ? i.setPoster(a)
                  ...
                  if (
                    ...
                    l.isDynamic
                      ...
                      : (function () {
                          ...
                          '' !== l.media.canPlayType((0, p.getTypeFromFile)(u)) && l.node.setAttribute('src', u),
            ...
            create: function (s, l, e) {
              ...
              for (
                var c = x.default.html5media.properties,
                  f = x.default.html5media.events.concat(['click', 'mouseover', 'mouseout']).filter(function (e) {
                    return 'error' !== e;
                  }),
                  p = function (e) {
          ...
          create: function (e, t, n) {
              ...
              var i = _.default.html5media.properties,
                a = function (t) {
                  ...
                  (r['get' + e] = function () {
                    ...
                    (r['set' + e] = function (e) {
                      if (('src' === t && (e = (0, j.absolutizeUrl)(e)), null !== r.flashApi && void 0 !== r.flashApi['set_' + t]))
                        try {
                          r.flashApi['set_' + t](e);
                        } catch (e) {}
            ...
            e.originalNode.getAttribute('src') && y.push('src=' + e.originalNode.getAttribute('src')),
              !0 === r.options.enablePseudoStreaming &&
                (y.push('pseudostreamstart=' + r.options.pseudoStreamingStartQueryParam), y.push('pseudostreamtype=' + r.options.pseudoStreamingType)),
            ...
            if (F.IS_IE || F.IS_EDGE) {
              ...
              (x = [
                ...
                E ? (x.push('width="' + S + '"'), x.push('height="' + b + '"')) : x.push('style="position: fixed; left: -9999em; top: -9999em;"'),
              ...
              if (
                ((E.default['__ready__' + l] = function (e) {
                  ...
                  for (var t, i = flvjs.Events, n = 0, o = c.length; n < o; n++)
                    'loadedmetadata' === (t = c[n]) && (u.unload(), u.detachMediaElement(), u.attachMediaElement(d), u.load()), d.addEventListener(t, f);
                  var r = function (o) {
                    i.hasOwnProperty(o) &&
                      u.on(i[o], function () {
                        for (var e = arguments.length, t = Array(e), n = 0; n < e; n++) t[n] = arguments[n];
      ...
      function (e, t, n) {
        ...
        var w = {
          ...
          s = {
            ...
            canPlayType: function (e) {
              return (
                o.HAS_MSE && -1 < ['application/x-mpegurl', 'application/vnd.apple.mpegurl', 'audio/mpegurl', 'audio/hls', 'video/hls'].indexOf(e.toLowerCase())
              );
            },
        ...
        var a = {
          ...
          canPlayType: function (e) {
            ...
            return (i.IS_ANDROID && /\/mp(3|4)$/i.test(e)) ||
              (~['application/x-mpegurl', 'vnd.apple.mpegurl', 'audio/mpegurl', 'audio/hls', 'video/hls'].indexOf(e.toLowerCase()) && i.SUPPORTS_NATIVE_HLS)
              ? 'yes'
              : t.canPlayType
          ...
          create: function (n, e, t) {
            var o = n.id + '_' + e.prefix,
              i = !1,
              r = null;
            void 0 === n.originalNode || null === n.originalNode ? ((r = g.default.createElement('audio')), n.appendChild(r)) : (r = n.originalNode),
              r.setAttribute('id', o);
            for (
            ...
            for (
              var u,
                c = y.default.html5media.events.concat(['click', 'mouseover', 'mouseout']).filter(function (e) {
                  return 'error' !== e;
                }),
                f = 0,
                p = c.length;
            ...
            create: function (m, n, o) {
              ...
              var p = 'audio' === m.originalNode.tagName.toLowerCase(),
                ...
                x = {
                  ...
                  height: E,
                  width: b,
                  host: h.options.youtube && h.options.youtube.nocookie ? 'https://www.youtube-nocookie.com' : void 0,
              ...
              return (
                ...
                ((x.playerVars.loop && 1 === parseInt(x.playerVars.loop, 10)) || -1 < m.originalNode.src.indexOf('loop=')) &&
                ...
                (h.getPosterUrl = function () {
                  ...
                  return e && -1 < ['default', 'hqdefault', 'mqdefault', 'sddefault', 'maxresdefault'].indexOf(e) && t
    ...
    25: [
      function (e, t, n) {
        ...
        A ? (j = r.default.mozFullScreenEnabled) : L && (j = r.default.msFullscreenEnabled),
          h && (k = !1),
          F &&
            (N ? (I = 'webkitfullscreenchange') : A ? (I = 'fullscreenchange') : L && (I = 'MSFullscreenChange'),
            (n.isFullScreen = M =
              function () {
    ...
    30: [
      function (e, t, n) {
        ...
        function s(e) {
          ...
          return (
            (o = C(t) ? c * i + f * r + u * a + s - d * ((l = 60 * i + r) - Math.floor(l / 10)) : (c * i + f * r + t * a + s) / t), parseFloat(o.toFixed(3))
          );
        }
        function l(e, t) {
        ...
        function d(e) {
          ...
          for (
            var t = ~(e = e.replace(',', '.')).indexOf('.') ? e.split('.')[1].length : 0, n = 0, o = 1, i = 0, r = (e = e.split(':').reverse()).length;
            i < r;
            i++
          )
