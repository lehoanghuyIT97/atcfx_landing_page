  ...
  (function (t) {
    ...
    function u(e, t) {
      ...
      !s.migrateIsPatchEnabled(e) ||
        ...
        r && r.warn && !s.migrateMute && (r.warn('JQMIGRATE: ' + t), s.migrateTrace && r.trace && r.trace()));
    }
          ...
          return e && 'object' == typeof e && !Array.isArray(e)
            ...
            : ('number' == typeof t &&
                ...
                (C.test(n) && N.test(n[0].toUpperCase() + n.slice(1))) ||
                  A[r] ||
                  u('css-number', 'Number-typed values are deprecated for jQuery.fn.css( "' + e + '", value )')),
        ...
        i(
          ...
          function () {
            1 < s.easing[this.easing].length &&
              (u('easing-one-arg', "'jQuery.easing." + this.easing.toString() + "' should use only one argument"), (s.easing[this.easing] = H)),
      ...
      i(
        ...
        function (e) {
          ...
          if (
            n &&
            !n._migrated_ &&
            ((n._migrated_ = !0), u('event-old-patch', 'jQuery.event.fixHooks are deprecated and removed: ' + r), (o = n.props) && o.length)
          )
            while (o.length) s.event.addProp(o.pop());
        ...
        function (e, t) {
          return (
            e === n &&
              ...
              u('load-after-event', "jQuery(window).on('load'...) called after load event occurred"),
            q.apply(this, arguments)
          );
        },
        'load-after-event'
    ...
    (s.UNSAFE_restoreLegacyHtmlPrefilter = function () {
      ...
      i(
        ...
        function (e) {
          var t, r;
          return (
            (r = (t = e).replace(F, '<$1></$2>')) !== t && T(t) !== T(r) && u('self-closed-tags', 'HTML tags must be properly nested and closed: ' + t),
            e.replace(F, '<$1></$2>')
          );
        },
        'self-closed-tags'
      ...
      i(
        ...
        function () {
          ...
          return !e || (e.nodeType && e.getBoundingClientRect)
            ...
            : (u('offset-valid-elem', 'jQuery.fn.offset() requires a valid DOM element'), arguments.length ? this : void 0);
        },
        'offset-valid-elem'
      ),
      s.ajax &&
        ...
        i(
          ...
          function (e, t) {
            ...
            return (
              void 0 === t && r && (u('param-ajax-traditional', 'jQuery.param() no longer uses jQuery.ajaxSettings.traditional'), (t = r)), D.call(this, e, t)
            );
          },
