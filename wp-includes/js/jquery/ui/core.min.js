    ...
    (x.ui.focusable = function (t, e) {
      ...
      return 'area' === s
        ? ((o = (i = t.parentNode).name),
          !(!t.href || !o || 'map' !== i.nodeName.toLowerCase()) && 0 < (i = x("img[usemap='#" + o + "']")).length && i.is(':visible'))
        ...
        ? ((v = 'string' == typeof (f = x.extend({}, f)).of ? x(document).find(f.of) : x(f.of)),
          ...
          x.each(['my', 'at'], function () {
            var t,
              e,
              i = (f[this] || '').split(' ');
            ((i = 1 === i.length ? (o.test(i[0]) ? i.concat(['center']) : s.test(i[0]) ? ['center'].concat(i) : ['center', 'center']) : i)[0] = o.test(i[0])
              ? i[0]
              : 'center'),
      ...
      flip: {
        left: function (t, e) {
          var i = e.within,
            ...
            h = -2 * e.offset[0];
          r < 0
            ? ((o = t.left + l + a + h + e.collisionWidth - o - n) < 0 || o < C(r)) && (t.left += l + a + h)
            : 0 < s && (0 < (n = t.left - e.collisionPosition.marginLeft + l + a + h - i) || C(n) < s) && (t.left += l + a + h);
        },
        top: function (t, e) {
          var i = e.within,
            ...
            h = -2 * e.offset[1];
          r < 0
            ? ((o = t.top + l + a + h + e.collisionHeight - o - n) < 0 || o < C(r)) && (t.top += l + a + h)
            : 0 < s && (0 < (n = t.top - e.collisionPosition.marginTop + l + a + h - i) || C(n) < s) && (t.top += l + a + h);
        },
      },
      flipfit: {
        left: function () {
  ...
  (x.cleanData =
      ...
      for (var e, i, n = p.call(arguments, 1), o = 0, s = n.length; o < s; o++)
        for (e in n[o])
          (i = n[o][e]),
            d.call(n[o], e) &&
              void 0 !== i &&
              (x.isPlainObject(i) ? (t[e] = x.isPlainObject(t[e]) ? x.widget.extend({}, t[e], i) : x.widget.extend({}, i)) : (t[e] = i));
      return t;
    }),
    ...
    (x.Widget.prototype = {
        ...
        for (e in t)
          (n = this.classesElementLookup[e]),
            t[e] !== this.options.classes[e] &&
              n &&
              n.length &&
              ((i = x(n.get())), this._removeClass(n, e), i.addClass(this._classes({ element: i, keys: e, classes: t, add: !0 })));
      },
      ...
      _classes: function (o) {
        ...
        return (
          (o = x.extend({ element: this.element, classes: this.options.classes || {} }, o)).keys && t(o.keys.match(/\S+/g) || [], !0),
