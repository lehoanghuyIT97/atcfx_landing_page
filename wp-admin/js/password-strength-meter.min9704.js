    ...
    (wp.passwordStrength = {
      ...
      userInputBlacklist: function () {
        return (
          window.console.log(
            n(
              e('%1$s is deprecated since version %2$s! Use %3$s instead. Please consider writing more inclusive code.'),
      ...
      userInputDisallowedList: function () {
        ...
        for (s.push(document.title), s.push(document.URL), n = o.length, e = 0; e < n; e++)
          0 !== (r = a('#' + o[e])).length && (s.push(r[0].defaultValue), s.push(r.val()));
