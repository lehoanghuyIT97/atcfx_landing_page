    ...
    (function (A) {
      ...
      var L = (A.tablesorter = {
        ...
        setup: function (t, r) {
          if (t && t.tHead && 0 !== t.tBodies.length && !0 !== t.hasInitialized) {
            ...
            (t.hasInitialized = !1),
              ...
              L.debug(r, 'core') &&
                (console[console.group ? 'group' : 'log']('Initializing tablesorter v' + L.version), A.data(t, 'startoveralltimer', new Date())),
              ...
              r.namespace
                ...
                : (r.namespace = '.tablesorter' + Math.random().toString(16).slice(2)),
              (r.table = t),
              ...
              r.$table.children('caption').length &&
                ((o = r.$table.children('caption')[0]).id || (o.id = r.namespace.slice(1) + 'caption'), r.$table.attr('aria-labelledby', o.id)),
              (r.widgetInit = {}),
              ...
              r.supportsDataObject && void 0 !== s.data().sortlist
                ...
                : a && s.metadata() && s.metadata().sortlist && (r.sortList = s.metadata().sortlist),
              L.applyWidget(t, !0),
              0 < r.sortList.length
                ? ((r.last.sortList = r.sortList), L.sortOn(r, r.sortList, {}, !r.initWidgets))
                : (L.setHeadersCss(r), r.initWidgets && L.applyWidget(t, !1)),
              r.showProcessing &&
                s.unbind('sortBegin' + r.namespace + ' sortEnd' + r.namespace).bind('sortBegin' + r.namespace + ' sortEnd' + r.namespace, function (e) {
              ...
              (t.isProcessing = !1),
              L.debug(r, 'core') &&
                (console.log('Overall initialization time:' + L.benchmark(A.data(t, 'startoveralltimer'))),
            ...
            L.debug(r, 'core') &&
              (t.hasInitialized
                ...
                : console.error('Stopping initialization! No table, thead or tbody', t));
        },
                ...
                if (
                  ...
                  if (
                    ...
                    L.regex.formElements.test(e.target.nodeName) ||
                      ...
                      0 < a.parents('.' + i.cssNoSort).length ||
        ...
        buildHeaders: function (d) {
                  ...
                  if (!L.getClosest(i, 'tr').hasClass(d.cssIgnoreRow))
                    return (
                      ...
                      '' === d.headerTemplate ||
                        ...
                        ((a = d.headerTemplate
                          .replace(L.regex.templateContent, i.html())
                          .replace(L.regex.templateIcon, i.find('.' + L.css.icon).length ? '' : l)),
                      ...
                      void 0 !== (n = L.getData(i, r, 'lockedOrder') || !1) &&
                        !1 !== n &&
                        ((d.sortVars[s].lockedOrder = !0), (d.sortVars[s].order = L.getOrder(n) ? [1, 1] : [0, 0])),
                      (d.headerList[t] = e),
          ...
          d.$table.find(d.selectorHeaders).attr({ scope: 'col', role: 'columnheader' }),
            L.updateHeader(d),
            L.debug(d, 'core') && (console.log('Built headers:' + L.benchmark(t)), console.log(d.$headers));
        },
        ...
        setupParsers: function (e, t) {
          var r,
            ...
            y = L.debug(e, 'core'),
            w = {};
          if (((e.$tbodies = e.$table.children('tbody:not(.' + e.cssInfoBlock + ')')), 0 === (h = (f = void 0 === t ? e.$tbodies : t).length)))
            return y ? console.warn('Warning: *Empty table!* Not building a parser cache') : '';
          for (
            y && ((u = new Date()), console[console.group ? 'group' : 'log']('Detecting parsers for each column')), o = { extractors: [], parsers: [] };
            b < h;
          ...
          y &&
            (L.isEmptyObject(w) ? console.warn('  No parsers detected!') : console[console.table ? 'table' : 'log'](w),
          ...
          for (var s, a, n, i = L.parsers.length, d = !1, l = '', c = L.debug(e, 'core'), g = !0; '' === l && g; )
            (n = t[++r]) && r < 50
              ? n.className.indexOf(L.cssIgnoreRow) < 0 &&
                ...
                (a = A(d)),
                c && console.log('Checking if value was empty on row ' + r + ', column: ' + o + ': "' + l + '"'))
              : (g = !1);
        ...
        getParsedText: function (e, t, r, o) {
          ...
          return (
            a &&
              (n && 'function' == typeof n.format && (o = n.format(o, e.table, t, r)),
        ...
        buildCache: function (e, t, r) {
          var o,
            ...
            T = L.debug(e, 'core');
          if (
            ((e.$tbodies = e.$table.children('tbody:not(.' + e.cssInfoBlock + ')')), (l = void 0 === r ? e.$tbodies : r), (e.cache = {}), (e.totalRows = 0), !R)
          )
                ...
                if (c.hasClass(e.cssChildRow) && 0 !== n)
                  ...
                  for (m.$row = c, m.order = n, x = 0, C = e.columns, i = 0; i < C; ++i) {
                    if (
                      ...
                      (!(v = void 0 !== R[x]) &&
                        T &&
                        console.warn('No parser found for row: ' + n + ', column: ' + i + '; cell containing: "' + A(u).text() + '"; does it have a header?'),
            ...
            for (
              $ = Math.min(5, e.cache[0].normalized.length),
                console[console.group ? 'group' : 'log'](
                  'Building cache for ' + e.totalRows + ' rows (showing ' + $ + ' rows in log) and ' + e.columns + ' columns' + L.benchmark(f)
                ),
                s = {},
                i = 0;
              i < e.columns;
        ...
        setColumnAriaLabel: function (e, t, r) {
          if (t.length) {
            ...
            t.hasClass('sorter-false') || !1 === r
              ...
              : ((a = (s.count + 1) % s.order.length), (r = s.order[a]), (n += L.language[0 === r ? 'nextAsc' : 1 === r ? 'nextDesc' : 'nextNone'])),
              t.attr('aria-label', n),
        ...
        updateHeaderSortCount: function (e, t) {
          ...
          for (e.sortList = [], a = 0; a < g; a++)
            if (((d = c[a]), (r = parseInt(d[0], 10)) < e.columns)) {
              switch (
                (e.sortVars[r].order ||
                  ((l = L.getOrder(e.sortInitialOrder) ? (e.sortReset ? [1, 0, 2] : [1, 0]) : e.sortReset ? [0, 1, 2] : [0, 1]),
        ...
        addRows: function (e, t, r, o) {
          ...
          if (((y.isUpdating = !0), L.isEmptyObject(e.cache))) L.updateHeader(e), L.commonUpdate(e, r, o);
            ...
            for (
              ...
              for (
                p = 0, c = t[i].cells.length, g = e.cache[n].normalized.length, f = [], u = { child: [], raw: [], $row: t.eq(i), order: g }, l = 0;
                l < c;
                l++
              )
                (h = t[i].cells[l]),
        ...
        initSort: function (t, e, r) {
          ...
          if (c) {
            ...
            for (t.sortVars[f].sortedBy = h, s = 0; s < t.sortList.length; s++)
          ...
          if (
            ...
            t.sortList.length && t.sortAppend && ((o = A.isArray(t.sortAppend) ? t.sortAppend : t.sortAppend[t.sortList[0][0]]), !L.isEmptyObject(o)))
          )
                    ...
                    if (
                      (n =
                        (o = /n/i.test(L.getSortType(l.parsers, s))) && l.strings[s]
                          ? ((o =
                              'boolean' == typeof L.string[l.strings[s]]
                                ? (u ? 1 : -1) * (L.string[l.strings[s]] ? -1 : 1)
                                : (l.strings[s] && L.string[l.strings[s]]) || 0),
                          ...
                          : ((i = u ? e : t),
                            ...
                            'function' == typeof f
                              ...
                              : 'function' == typeof p[s]
                                ? p[s](i[s], d[s], u, s, g)
                                : L['sortNatural' + (u ? 'Asc' : 'Desc')](e[s] || '', t[s] || '', s, l)))
                    )
                      return n;
                  }
        ...
        sortNatural: function (e, t) {
          ...
          for (
            r = e.replace(d.chunk, '\\0$1\\0').replace(d.chunks, '').split('\\0'),
            ...
            if (((s = isNaN(r[n]) ? r[n] || 0 : parseFloat(r[n]) || 0), (a = isNaN(o[n]) ? o[n] || 0 : parseFloat(o[n]) || 0), isNaN(s) !== isNaN(a)))
              return isNaN(s) ? 1 : -1;
          ...
          if (a)
            for (t = 0; t < a; t++)
              (r = L.getWidgetById(s.widgets[t])) &&
                r.options &&
                ((o = A.extend(!0, {}, r.options)), (s.widgetOptions = A.extend(!0, o, s.widgetOptions)), A.extend(!0, L.defaults.widgetOptions, r.options));
        },
        ...
        applyWidgetId: function (e, t, r) {
          ...
          l &&
            ...
            d &&
              o &&
              (console.log('Completed ' + (r ? 'initializing ' : 'applying ') + a + ' widget' + L.benchmark(s)), console.groupEnd && console.groupEnd()));
        },
            ...
            if ((l && (i = new Date()), L.addWidgetFromClass(e), clearTimeout(d.timerReady), d.widgets.length)) {
              for (
                ...
                (n = L.getWidgetById(a[o])) && n.id
                  ? (n.priority || (n.priority = 10), (c[o] = n))
                  : l && console.warn('"' + a[o] + '" was enabled, but the widget code has not been loaded!');
              for (
                c.sort(function (e, t) {
        ...
        removeWidget: function (e, t, r) {
          ...
          for (n = t.length, o = 0; o < n; o++)
            (s = L.getWidgetById(t[o])),
              ...
              s &&
                s.remove &&
                (L.debug(i, 'core') && console.log((r ? 'Refreshing' : 'Removing') + ' "' + t[o] + '" widget'),
        ...
        formatFloat: function (e, t) {
          return 'string' != typeof e || '' === e
            ? e
            : ((e = (t && t.config ? !1 !== t.config.usNumberFormat : void 0 === t || t)
                ? e.replace(L.regex.comma, '')
                : e.replace(L.regex.digitNonUS, '').replace(L.regex.comma, '.')),
          ...
          (e = (e || '').replace(L.regex.spaces, ' ').replace(L.regex.shortDateReplace, '/')),
            'mmddyyyy' === t
              ...
              : 'ddmmyyyy' === t
                ...
                : 'yyyymmdd' === t && (e = e.replace(L.regex.shortDateYMD, '$1/$2/$3'));
          var r = new Date(e);
...
!(function (e) {
  ...
  8: function (e, t) {
    var n = function (e, t) {
        ...
        n.data('table_id');
        if (
          ('undefined' != typeof enableProSorter &&
            t.isFunction(enableProSorter) &&
          ...
          e.find('.eael-data-table')
            ...
            .each(function (e, n) {
              t(n)
                ...
                .each(function (e, n) {
                  0 == r.eq(e).length
                    ? t(this).prepend('<div class="th-mobile-screen"></div>')
                    : t(this).prepend('<div class="th-mobile-screen">' + r.eq(e).html() + '</div>');
                });
            });
        }
      },
      r = function (e, t, n) {
        if ('ea:table:export' == event.target.dataset.event) {
          for (var r = n.el.querySelector('#eael-data-table-' + t.attributes.id).querySelectorAll('table tr'), a = [], o = 0; o < r.length; o++) {
            for (var i = [], l = r[o].querySelectorAll('th, td'), d = 0; d < l.length; d++)
              i.push(JSON.stringify(l[d].innerText.replace(/(\r\n|\n|\r)/gm, ' ').trim()));
            a.push(i.join(','));
          }
          var u = new Blob([a.join('\n')], { type: 'text/csv' }),
            c = parent.document.createElement('a');
          c.classList.add('eael-data-table-download-' + t.attributes.id),
            (c.download = 'eael-data-table-' + t.attributes.id + '.csv'),
            (c.href = window.URL.createObjectURL(u)),
            (c.style.display = 'none'),
            parent.document.body.appendChild(c),
            c.click(),
            parent.document.querySelector('.eael-data-table-download-' + t.attributes.id).remove();
        }
      },
      a = function (e, t, n) {
        var a = r.bind(this, e, t, n);
        e.el.addEventListener('click', a),
          e.currentPageView.on('destroy', function () {
            e.el.removeEventListener('click', a);
          });
      };
    jQuery(window).on('elementor/frontend/init', function () {
      if (ea.elementStatusCheck('eaelDataTable')) return !1;
      isEditMode && elementor.hooks.addAction('panel/open_editor/widget/eael-data-table', a),
        elementorFrontend.hooks.addAction('frontend/element_ready/eael-data-table.default', n);
    });
  },
});
!(function (e) {
  ...
  7: function (e, t) {
    window.enableProSorter = function (e, t) {
      var n = t.data('table_enabled'),
        r = t.data('table_id');
      1 == n && e('#eael-data-table-' + r).tablesorter(),
        1 != n &&
          (e('table#eael-data-table-' + r + ' .sorting').addClass('sorting-none'),
          e('table#eael-data-table-' + r + ' .sorting_desc').addClass('sorting-none'),
          e('table#eael-data-table-' + r + ' .sorting_asc').addClass('sorting-none'));
    };
  },
});
