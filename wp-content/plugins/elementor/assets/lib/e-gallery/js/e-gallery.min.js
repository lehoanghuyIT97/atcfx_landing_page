          ...
          a()(t, [
            ...
            },
            {
              ...
              value: function (t, e) {
                var i = e.split('.'),
                  n = i.splice(0, 1);
                return i.length ? this.getNestedObjectData(t[n], i.join('.')) : { object: t, key: e };
              },
            },
            {
              key: 'getTemplateArgs',
            ...
            },
            {
              ...
              value: function (t) {
                var e,
                  ...
                  n = jQuery('<div>', { class: this.getItemClass(i.item), 'data-e-gallery-tags': t.tags }),
                ...
                var r = n;
                return t.url && ((r = jQuery('<a>', { class: this.getItemClass(i.link), href: t.url })), n.html(r)), r.html(s), e && r.append(e), n;
              },
            },
            {
              key: 'debounce',
                    ...
                    return (
                      new Promise(function (t) {
                        ...
                        r
                          ...
                          .addClass(t.getItemClass(t.settings.classes.imageLoaded)),
                          t.loadedItemsCount++,
            ...
            },
            {
              ...
              value: function (t, e) {
                this.imagesData[e] = { width: t.width, height: t.height, ratio: t.width / t.height };
              },
            },
            {
                ...
                (this.$items = this.$container.find(t.items)),
                  this.$items.each(function (n, s) {
                    ...
                    (i[n] = { thumbnail: r.data('thumbnail') }),
                      e
                        ? ((i[n].width = r.data('width')), (i[n].height = r.data('height')))
                        : r.css('background-image', 'url("'.concat(r.data('thumbnail'), '")'));
                  }),
          ...
          a()(e, [
            {
              key: 'getDefaultSettings',
              value: function () {
                return { idealRowHeight: 200, lastRow: 'auto', breakpoints: { 1024: { idealRowHeight: 150 }, 768: { idealRowHeight: 100 } } };
              },
            },
            {
              key: 'run',
              ...
              value: function (t) {
                for (var e = 0, i = t; ; i++) {
                  ...
                  if (((n.computedWidth = s), a)) {
                    ...
                    if ('hide' !== o) {
                      var l = 'fit' === o || 0.7 <= r / this.containerWidth ? r : this.containerWidth;
                ...
                if (t || i !== this.currentBreakpoint) {
                  ...
                  for (
                    var n = [],
                      ...
                      l = (o - this.getCurrentDeviceSetting('horizontalGap') * (a - 1)) / a,
        ...
        a()(t, [
          {
            ...
            value: function () {
              return {
                ...
                selectors: { items: '.e-gallery-item', image: '.e-gallery-image' },
                breakpoints: { 1024: { horizontalGap: 5, verticalGap: 5, columns: 4 }, 768: { horizontalGap: 1, verticalGap: 1, columns: 2 } },
              };
            },
          },
          {
