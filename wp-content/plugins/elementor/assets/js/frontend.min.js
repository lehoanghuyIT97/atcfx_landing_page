  ...
  [819],
  {
      ...
      e.exports = function (e) {
        ...
        (this.elementsHandlers = {
          ...
          elementorFrontendConfig.experimentalFeatures['nested-elements'] &&
            (this.elementsHandlers['nested-tabs.default'] = () => Promise.resolve().then(n.bind(n, 7323))),
          elementorFrontendConfig.experimentalFeatures['nested-elements'] &&
    ...
    9501: (e, t) => {
      ...
      class BackgroundVideo extends elementorModules.frontend.handlers.Base {
        ...
        getDefaultElements() {
          ...
          return (
            (t.$backgroundVideoEmbed = t.$backgroundVideoContainer.children(e.backgroundVideoEmbed)),
        ...
        activate() {
          ...
          if (
            (-1 !== t.indexOf('vimeo.com')
              ...
              : t.match(/^(?:https?:\/\/)?(?:www\.)?(?:m\.)?(?:youtu\.be\/|youtube\.com)/) &&
                ((this.videoType = 'youtube'), (this.apiProvider = elementorFrontend.utils.youtube)),
            this.apiProvider)
          )
        ...
        deactivate() {
          ('youtube' === this.videoType && this.player.getIframe()) || 'vimeo' === this.videoType
            ? this.player.destroy()
        ...
        getSvgURL(e, t) {
          ...
          return (
            elementor.config.additional_shapes &&
              ...
              ((n = elementor.config.additional_shapes[e]), -1 < t.indexOf('-negative') && (n = n.replace('.svg', '-negative.svg'))),
            n
          );
        }
        buildSVG(e) {
      ...
      class LightboxManager extends elementorModules.ViewModule {
        ...
        isLightboxLink(e) {
          if (
            ...
            (e.hasAttribute('download') || !/^[^?]+\.(png|jpe?g|gif|svg|webp)(\?.*)?$/i.test(e.href)) &&
          ...
          return (
            Object.keys(e.breakpoints).forEach(o => {
              ...
              (e.breakpoints[s] = e.breakpoints[o]),
                (e.breakpoints[o] = { slidesPerView: e.slidesPerView, slidesPerGroup: e.slidesPerGroup ? e.slidesPerGroup : 1 });
            }),
            e
          );
        }
    ...
    6028: (e, t) => {
      ...
      t.isScrollSnapActive = () =>
        'yes' ===
        (elementorFrontend.isEditMode() ? elementor.settings.page.model.attributes?.scroll_snap : elementorFrontend.config.settings.page?.scroll_snap);
    },
    4773: (e, t) => {
      Object.defineProperty(t, '__esModule', { value: !0 }), (t.default = void 0);
    ...
    3308: (e, t) => {
      ...
      const matchUserAgent = e => n.indexOf(e) >= 0,
        ...
        s =
          ...
          '[object SafariRemoteNotification]' === (!window.safari || ('undefined' != typeof safari && safari.pushNotification)).toString(),
