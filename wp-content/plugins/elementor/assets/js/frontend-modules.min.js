      ...
      class NestedTitleKeyboardHandler extends r.default {
        ...
        handleContentElementKeyboardNavigation(e) {
          'Tab' !== e.key || e.shiftKey
            ? 'Escape' === e.key && (e.preventDefault(), e.stopPropagation(), this.handleContentElementEscapeEvents(e))
    ...
    3090: e => {
      ...
      e.exports = elementorModules.ViewModule.extend({
        ...
        isElementInTheCurrentDocument() {
          return (
            !!elementorFrontend.isEditMode() && elementor.documents.currentDocument.id.toString() === this.$element[0].closest('.elementor').dataset.elementorId
          );
        },
        findElement(e) {
          var t = this.$element;
    ...
    1192: (e, t, n) => {
      ...
      (Module.prototype.__construct = function () {}),
        ...
        (Module.extend = function (e) {
          ...
          return (
            t.extend(child, n), ((child.prototype = Object.create(t.extend({}, n.prototype, e))).constructor = child), (child.__super__ = n.prototype), child
          );
        }),
        (e.exports = Module);
    },
      ...
      class NestedAccordion extends r.default {
        ...
        injectKeyboardHandler() {
          'nested-accordion.default' === this.getSettings('elementName') &&
            new s.default({ $element: this.$element, toggleTitle: this.clickListener.bind(this) });
        }
        interlaceContainers() {
          ...
          var T = i('Error'),
            C = t(function (e, t) {
              var n = d(m ? t : e, void 0),
                i = m ? new w(e) : new w();
              return (
                void 0 !== n && s(i, 'message', n), g(i, C, i.stack, 2), this && o(E, this) && u(i, this, C), arguments.length > b && h(i, arguments[b]), i
              );
            });
          if (
            ((C.prototype = E), 'Error' !== S ? (a ? a(C, T) : l(C, T, { name: !0 })) : p && v in w && (c(C, w, v), c(C, w, 'prepareStackTrace')), l(C, w), !f)
          )
            try {
