    ...
    var o = function (e) {
      return 'string' != typeof e || '' === e
        ...
        : /^__/.test(e)
          ...
          : !!/^[a-zA-Z][a-zA-Z0-9_.-]*$/.test(e) || (console.error('The hook name can only contain numbers, letters, dashes, periods and underscores.'), !1);
    };
    var i = function (e, t) {
    ...
    var a = function (e, t) {
      ...
      return function (i, a) {
        ...
        if (o(i) && (r || n(a))) {
          if (!s[i]) return 0;
          var c = 0;
          if (r) (c = s[i].handlers.length), (s[i] = { runs: s[i].runs, handlers: [] });
          else
            for (
              var l = s[i].handlers,
                u = function (e) {
                ...
                if (n && (e(o).hasClass('eael-tab-item-trigger') || e(o).hasClass('eael-accordion-header')))
                  if ((e(o).trigger('click'), void 0 !== o && o))
                    if (e(o).closest('.eael-advance-tabs').length > 0) {
                      ...
                      (a = a ? parseFloat(a) : 0), e('html, body').animate({ scrollTop: e(o).offset().top - a }, 300);
                    }
              }
            } catch (e) {}
          }),
