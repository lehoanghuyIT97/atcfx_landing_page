      ...
      class BaseFilterFrontendModule extends elementorModules.Module {
        ...
        prepareLoopUpdateRequestData(e, t) {
          ...
          if (elementorFrontend.isEditMode()) {
            ...
            (o.widget_model = t.model.toJSON({ remove: ['default', 'editSettings', 'defaultEditSettings'] })), (o.is_edit_mode = !0);
          }
          return o;
        }
        ...
        getFetchArgumentsForLoopUpdate(e, t) {
          const n = this.prepareLoopUpdateRequestData(e, t),
            s = { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(n) };
          return (
            elementorFrontend.isEditMode() && elementorPro.config.loopFilter?.nonce && (s.headers['X-WP-Nonce'] = elementorPro.config.loopFilter?.nonce), s
          );
        }
        ...
        consolidateFilters(e) {
          ...
          for (const e in t) {
            ...
            0 !== r.terms.length &&
              ...
              !r.terms ||
                (n[o][r.selectedTaxonomy].terms && n[o][r.selectedTaxonomy].terms.includes(r.terms)) ||
                (n[o][r.selectedTaxonomy] = { terms: 'string' === r.terms ? [r.terms] : r.terms }),
              r.logicalJoin &&
                !n[o][r.selectedTaxonomy].logicalJoin &&
                (n[o][r.selectedTaxonomy] = { ...(n[o][r.selectedTaxonomy] || {}), logicalJoin: r.logicalJoin ?? 'AND' }));
          }
          ...
          s.setMessage(this.$element).show(),
            this.isEdit ||
              (n.close_button_delay &&
                (o.hide(), clearTimeout(this.closeButtonTimeout), (this.closeButtonTimeout = setTimeout(() => o.show(), 1e3 * n.close_button_delay))),
            ...
            if (!e) {
              const t = this.getDocumentSettings(),
                ...
                triggerPopupEvent = e => {
                  ...
                  elementorFrontend.elements.$document.trigger(t, [n, this]), window.dispatchEvent(new CustomEvent(t, { detail: { id: n, instance: this } }));
                };
              ...
              elementorFrontend.config.experimentalFeatures.e_font_icon_svg && (o.closeButtonOptions = { iconElement: i.close.element }),
            ...
            this.isEdit
              ...
              : (this.$element.show().remove(),
                ...
                elementorFrontend.isEditMode() ||
                  (elementorFrontend.isWPPreviewMode() && elementorFrontend.config.post.id === this.getSettings('id') ? this.showModal() : this.startTiming()));
        }
        onSettingsChange(e) {
    ...
    5503: (e, t, n) => {
      ...
      class _default extends o.default {
        constructor() {
          ...
          (this.settings = { timezone: e, startDate: !!t && new Date(t), endDate: !!n && new Date(n), serverDatetime: !!s && new Date(s) }),
      ...
      class _default extends o.default {
        ...
        check() {
          ...
          return 0 === t.indexOf(location.host.replace('www.', ''))
            ...
            : -1 !== e.indexOf('external') || (-1 !== e.indexOf('search') && /^(google|yahoo|bing|yandex|baidu)\./.test(t));
        }
      }
      t.default = _default;
    },
      ...
      class _default extends o.default {
        constructor() {
          ...
          (this.settings = { countOnOpen: e, period: t, showsLimit: parseInt(n) }),
            ...
            ['', 'close'].includes(this.settings.countOnOpen) ? ((this.settings.countOnOpen = !1), this.onPopupHide()) : (this.settings.countOnOpen = !0),
            (this.utils = new r.default({ uniqueId: this.uniqueId, settings: this.settings, storage: elementorFrontend.storage }));
        }
        getName() {
          return 'times';
        }
          ...
          super(),
            ...
            elementorFrontend.isEditMode() &&
              elementorFrontend.on('components:init', () => {
                elementorFrontend.elements.$body.find('.elementor-widget-woocommerce-cart').length ||
