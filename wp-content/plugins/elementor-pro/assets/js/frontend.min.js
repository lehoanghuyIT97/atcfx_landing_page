  ...
  [819],
  {
    ...
    3515: (e, t, n) => {
      ...
      class _default extends elementorModules.frontend.handlers.Base {
        ...
        prepareOptions(e) {
          ...
          return (
            a.range || 'fixed' !== this.getCurrentDeviceSetting('_position') || (a.range = 'page'),
        ...
        toggle() {
          ...
          ['motion_fx', 'background_motion_fx'].forEach(n => {
            ...
            (!s || -1 !== s.indexOf(e)) && (t[n + '_motion_fx_scrolling'] || t[n + '_motion_fx_mouse'])
              ? this[n]
        ...
        onElementChange(e) {
          if (/motion_fx_((scrolling)|(mouse)|(devices))$/.test(e))
            return 'motion_fx_motion_fx_scrolling' === e && this.addCSSTransformEvents(), void this.toggle();
    ...
    2292: (e, t) => {
      ...
      class _default extends elementorModules.Module {
          ...
          return (
            e < n.start
              ? 'out-in' === t
                ...
                : 'in-out' === t
                  ? (s = 100)
                  : ((s = this.getMovePointFromPassedPercents(n.start, e)), 'in-out-in' === t && (s = 100 - s))
              : e < n.end
                ? 'in-out-in' === t
                  ? (s = 0)
                  : 'out-in-out' === t
                    ? (s = 100)
                    : ((s = this.getMovePointFromPassedPercents(n.end - n.start, e - n.start)), 'in-out' === t && (s = 100 - s))
                : 'in-out' === t
                  ? (s = 0)
                  : 'out-in' === t
                    ? (s = 100)
                    : ((s = this.getMovePointFromPassedPercents(100 - n.end, 100 - e)), 'in-out-in' === t && (s = 100 - s)),
            s
          );
        }
        translateX(e, t) {
        ...
        refresh() {
          (this.rulesVariables = {}), (this.CSSTransformVariables = []), this.$element.css({ transform: '', filter: '', opacity: '', 'will-change': '' });
        }
        onInit() {
      ...
      class MouseMoveInteraction extends i.default {
        bindEvents() {
          MouseMoveInteraction.mouseTracked ||
            (elementorFrontend.elements.$window.on('mousemove', MouseMoveInteraction.updateMousePosition), (MouseMoveInteraction.mouseTracked = !0));
        }
        run() {
          ...
          (e =
            'page' === this.motionFX.getSettings('range')
              ...
              : this.motionFX.getSettings('isFixedPosition')
                ...
                : elementorModules.utils.Scroll.getElementViewportPercentage(this.motionFX.elements.$parent)),
            this.runCallback(e);
        }
      }
      t.default = _default;
      ...
      class _default extends elementorModules.ViewModule {
        ...
        updateBackgroundLayerSize() {
          ...
          n && n.translateXY && ((t.x = 10 * n.translateXY.speed), (t.y = 10 * n.translateXY.speed)),
            s && (s.translateX && (t.x = 10 * s.translateX.speed), s.translateY && (t.y = 10 * s.translateY.speed)),
    ...
    2090: (e, t) => {
      ...
      t.default = elementorModules.frontend.handlers.Base.extend({
        ...
        onElementChange(e) {
          ...
          -1 !== [...this.getResponsiveSettingList('sticky_offset'), ...this.getResponsiveSettingList('sticky_effects_offset'), 'sticky_parent'].indexOf(e) &&
            this.reactivate();
        },
        onDeviceModeChange() {
          ...
          super(),
            elementorFrontend.hooks.addAction('frontend/element_ready/video-playlist.default', e => {
              n.e(721)
                ...
                .then(t => {
                  let { default: n } = t;
                  elementorFrontend.elementsHandler.addHandler(n, { $element: e, toggleSelf: !1 });
                });
            });
        }
      }
