  ...
  var o = function (o, s) {
    var i,
      ...
      l = {
        ...
        effectsOffset: 0,
        parent: !1,
        classes: { sticky: 'sticky', stickyActive: 'sticky-active', stickyEffects: 'sticky-effects', spacer: 'sticky-spacer' },
        isRTL: !1,
    ...
    var h = function () {
        (p.$spacer = i.clone().addClass(e.classes.spacer).css({ visibility: 'hidden', transition: 'none', animation: 'none' })), i.after(p.$spacer);
      },
      y = function () {
        p.$spacer.remove();
      },
      ...
      $ = function () {
        ...
        if (c) {
          (o ? t.top.fromTop > e.offset : t.bottom.fromBottom < -e.offset) &&
            (p.$parent.css(m(p.$parent, 'childNotFollowing')), i.css(m(i, 'notFollowing')), (c = !1));
        } else {
          var s = w(p.$parent),
    ...
    (this.destroy = function () {
      ...
      (p.$window = t(window)),
      e.parent && ((p.$parent = i.parent()), 'parent' !== e.parent && (p.$parent = p.$parent.closest(e.parent))),
