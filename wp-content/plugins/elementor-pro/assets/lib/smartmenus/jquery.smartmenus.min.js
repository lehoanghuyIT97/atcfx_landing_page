          ...
          mousemove: function (b) {
            ...
            if (k) {
              ...
              if ((d > 0 || g > 0) && d <= 4 && g <= 4 && c.timeStamp - k.timeStamp <= 300 && ((f = !0), j)) {
                ...
                h.is('a') &&
                  a.each(e, function () {
                    if (a.contains(this.$root[0], h[0])) return this.itemEnter({ currentTarget: h[0] }), !1;
                  }),
                  (j = !1);
              }
            }
      ...
      prototype: {
          ...
          if (!c) {
            ...
            this.$root
              ...
              this.opts.subIndicators &&
                ((this.$subArrow = a('<span/>').addClass('sub-arrow')), this.opts.subIndicatorsText && this.$subArrow.html(this.opts.subIndicatorsText)),
              b();
          }
          if (
            ...
            .each(function () {
              ...
              b.dataSM('scroll-arrows') && b.dataSM('scroll-arrows').remove(),
                b.dataSM('shown-before') &&
                  ((d.opts.subMenusMinWidth || d.opts.subMenusMaxWidth) && b.css({ width: '', minWidth: '', maxWidth: '' }).removeClass('sm-nowrap'),
                  b.dataSM('scroll-arrows') && b.dataSM('scroll-arrows').remove(),
                  b.css({ zIndex: '', top: '', left: '', marginLeft: '', marginTop: '', display: '' })),
        ...
        docClick: function (b) {
          return this.$touchScrollingSub
            ...
            : void (((this.visibleSubMenus.length && !a.contains(this.$root[0], b.target)) || a(b.target).closest('a').length) && this.menuHideAll());
        },
        ...
        getOffset: function (a, b) {
          var c;
          'none' == a.css('display') &&
            ((c = { position: a[0].style.position, visibility: a[0].style.visibility }), a.css({ position: 'absolute', visibility: 'hidden' }).show());
        ...
        itemActivate: function (b, c) {
          ...
          if (
            ((this.isCollapsible() && !c) || this.menuHideSubMenus(this.activatedItems[e - 1] && this.activatedItems[e - 1][0] == b[0] ? e : e - 1),
        ...
        itemClick: function (b) {
          ...
          if (this.handleItemEvents(c)) {
            ...
            if (d) {
              ...
              } else if ((!i || !g || f) && (!g && this.opts.showOnClick && e && (this.clickActivated = !0), this.itemActivate(c, j), d.is(':visible')))
        ...
        itemFocus: function (b) {
          ...
          this.handleItemEvents(c) &&
            (!this.focusActivated ||
              ...
              (this.activatedItems.length && this.activatedItems[this.activatedItems.length - 1][0] == c[0]) ||
        ...
        itemLeave: function (b) {
          var c = a(b.currentTarget);
          this.handleItemEvents(c) &&
            (this.isTouchMode() || (c[0].blur(), this.showTimeout && (clearTimeout(this.showTimeout), (this.showTimeout = 0))),
        ...
        menuHideAll: function () {
          ...
          this.opts.isPopup &&
            ...
            this.$root.is(':visible') &&
              (k && this.opts.hideFunction ? this.opts.hideFunction.call(this, this.$root) : this.$root.hide(this.opts.hideDuration))),
            (this.activatedItems = []),
            (this.visibleSubMenus = []),
            (this.clickActivated = !1),
            (this.focusActivated = !1),
        ...
        menuInit: function (a) {
          if (!a.dataSM('in-mega')) {
            ...
            d.attr({ id: e, 'aria-haspopup': 'true', 'aria-controls': f, 'aria-expanded': 'false' }),
              a.attr({ id: f, role: 'group', 'aria-hidden': 'true', 'aria-labelledby': e, 'aria-expanded': 'false' }),
        ...
        menuPosition: function (b) {
          ...
          if (
            ...
            var A = n + c,
              B = o + e;
            if (
              (x && A < s ? (c = w ? s - A + c : p - y) : !x && A + k > s + u && (c = w ? s + u - k - A + c : y - k),
              ...
              b.dataSM('scroll-arrows') ||
                b.dataSM(
                  ...
                  a([
                    ...
                    a('<span class="scroll-down"><span class="scroll-down-arrow"></span></span>')[0],
                  ])
                    .on({
                      mouseenter: function () {
        ...
        menuScroll: function (a, b, c) {
          ...
          if (!b && e.momentum) {
            if (((e.momentum *= 0.92), (d = e.momentum), d < 0.5)) return void this.menuScrollStop(a);
          ...
          if (
            ...
            a.css(
              this.cssTransforms3d
                ? { '-webkit-transform': 'translate3d(0, ' + e.y + 'px, 0)', transform: 'translate3d(0, ' + e.y + 'px, 0)' }
                : { marginTop: e.y }
            ),
        ...
        menuScrollOut: function (b, c) {
          f &&
            (/^scroll-(up|down)/.test((c.relatedTarget || '').className) ||
              ((b[0] == c.relatedTarget || a.contains(b[0], c.relatedTarget)) && this.getClosestMenu(c.relatedTarget) == b[0]) ||
        ...
        menuScrollRefreshData: function (b) {
          ...
          this.cssTransforms3d && (d = -(parseFloat(b.css('margin-top')) - d)), a.extend(c, { upEnd: d, downEnd: d + this.getViewportHeight() - c.subH });
        },
          ...
          if (((d = d.originalEvent), c(d))) {
            ...
            if (this.getClosestMenu(e.target) == b[0]) {
              ...
              if (/(start|down)$/i.test(d.type))
                this.menuScrollStop(b) ? (d.preventDefault(), (this.$touchScrollingSub = b)) : (this.$touchScrollingSub = null),
                  this.menuScrollRefreshData(b),
                ...
                if (void 0 !== g && g != e.pageY) {
                  ...
                  var h = g < e.pageY;
                  void 0 !== f.up && f.up != h && a.extend(f, { touchStartY: e.pageY, touchStartTime: d.timeStamp }),
                ...
                void 0 !== f.touchY &&
                  ((f.momentum = 15 * Math.pow(Math.abs(e.pageY - f.touchStartY) / (d.timeStamp - f.touchStartTime), 2)) &&
        ...
        menuShow: function (a) {
          if (
            (a.dataSM('beforefirstshowfired') || (a.dataSM('beforefirstshowfired', !0), this.$root.triggerHandler('beforefirstshow.smapi', a[0]) !== !1)) &&
            ...
            if (((this.opts.keepHighlighted || c) && b.addClass('highlighted'), c))
              a.removeClass('sm-nowrap').css({ zIndex: '', width: 'auto', minWidth: '', maxWidth: '', top: '', left: '', marginLeft: '', marginTop: '' });
            else {
              if (
            ...
            switch (b.keyCode) {
              ...
              case 32:
                ...
                if (e.is('a') && this.handleItemEvents(e)) {
                  var d = e.dataSM('sub');
                  d && !d.is(':visible') && (this.itemClick({ currentTarget: b.target }), b.preventDefault());
                }
            }
        },
        rootOut: function (a) {
        ...
        winResize: function (a) {
          if (this.handleEvents()) {
            if (!('onorientationchange' in window) || 'orientationchange' == a.type) {
              ...
              (this.wasCollapsible && b) || (this.activatedItems.length && this.activatedItems[this.activatedItems.length - 1][0].blur(), this.menuHideAll()),
                (this.wasCollapsible = b);
            }
          } else if (this.$disableOverlay) {
            var c = this.$root.offset();
            this.$disableOverlay.css({ top: c.top, left: c.left, width: this.$root.outerWidth(), height: this.$root.outerHeight() });
          }
        },
      },
    }),
    ...
    (a.fn.smartmenus = function (b) {
      ...
      return this.each(function () {
        ...
        c && 'object' != typeof c && ((c = null), alert('ERROR\n\nSmartMenus jQuery init:\nThe value of the "data-sm-options" attribute must be valid JSON.')),
          c &&
            a.each(['showFunction', 'hideFunction', 'collapsibleShowFunction', 'collapsibleHideFunction'], function () {
