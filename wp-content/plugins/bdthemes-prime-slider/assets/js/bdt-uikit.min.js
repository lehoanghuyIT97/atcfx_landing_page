...
/*! bdtUIkit 3.15.22 | https://www.getuikit.com | (c) 2014 - 2023 YOOtheme | MIT License */ (function (fe, pe) {
  typeof exports == 'object' && typeof module < 'u'
    ? (module.exports = pe())
    : typeof define == 'function' && define.amd
      ? define('uikit', pe)
      : ((fe = typeof globalThis < 'u' ? globalThis : fe || self), (fe.bdtUIkit = pe()));
})(this, function () {
  'use strict';
  ...
  function Ct(t, e, i = 0, s = !1) {
    ...
    const { length: n } = e;
    return n
      ? ((t = Mt(t) ? Tt(t) : t === 'next' ? i + 1 : t === 'previous' ? i - 1 : e.indexOf(W(t))), s ? K(t, 0, n - 1) : ((t %= n), t < 0 ? t + n : t))
      : -1;
  }
  function ft(t) {
  ...
  function ys(t, e) {
    const i = { data: null, method: 'GET', headers: {}, xhr: new XMLHttpRequest(), beforeSend: C, responseType: '', ...e };
  ...
  function Ao(t, e) {
    return new Promise((i, s) => {
      ...
      S(n, 'load', () => {
        n.status === 0 || (n.status >= 200 && n.status < 300) || n.status === 304 ? i(n) : s($t(Error(n.statusText), { xhr: n, status: n.status }));
      }),
            ...
            new Promise((o, r) => {
              ...
              z(
                ...
                ({ type: l }) => {
                  clearTimeout(a),
                    B(n, 'bdt-transition'),
                    c(n, { transitionProperty: '', transitionDuration: '', transitionTimingFunction: '' }),
                    l === 'transitioncanceled' ? r() : o(n);
                },
                { self: !0 }
              ),
                x(n, 'bdt-transition'),
                c(n, { transitionProperty: Object.keys(e).map(Ni).join(','), transitionDuration: `${i}ms`, transitionTimingFunction: s, ...e });
            })
        )
      )
    );
        ...
        o =>
          new Promise((r, a) => {
            ...
            z(
              ...
              at(e, ye) && (s && x(o, `bdt-transform-origin-${s}`), n && x(o, `${ye}reverse`));
          })
      )
    );
  }
  ...
  function w(t) {
    const e = Kt(t) ? W(t).getBoundingClientRect() : { height: Z(t), width: Se(t), top: 0, left: 0 };
  ...
  function Vo() {
    return (
      Te ||
      (ne || ((ne = v('<div>')), c(ne, { height: '100vh', position: 'fixed' }), S(window, 'resize', () => (Te = null))),
      L(document.body, ne),
      (Te = ne.clientHeight),
      st(ne),
      Te)
  ...
  const X = {};
  (X.events = X.created = X.beforeConnect = X.connected = X.beforeDisconnect = X.disconnected = X.destroy = Vi),
    (X.args = function (t, e) {
      return e !== !1 && Vi(e || t);
    }),
  ...
  function le(t, e, i) {
    const s = {};
    if ((dt(e) && (e = e.options), e.extends && (t = le(t, e.extends, i)), e.mixins)) for (const o of e.mixins) t = le(t, o, i);
  ...
  function Ns(t) {
    ii(t) && Yi(t, { func: 'mute', method: 'setVolume', value: 0 }), ei(t) && (t.muted = !0);
  }
  function Hs(t) {
    return ei(t) || ii(t);
  }
  ...
  function qs(t, e, i) {
    (i = { attach: { element: ['left', 'top'], target: ['left', 'top'], ...i.attach }, offset: [0, 0], placement: [], ...i }),
      J(e) || (e = [e, e]),
      _(t, Vs(t, e, i));
  }
  function Vs(t, e, i) {
  ...
  function Ys(t, e, i) {
    let { attach: s, offset: n } = { attach: { element: ['left', 'top'], target: ['left', 'top'], ...i.attach }, offset: [0, 0], ...i },
      o = _(t);
  ...
  function tr(t, e, i, s) {
    const [n, o, r, a] = rt[s],
      ...
      h = ot(l);
    return (
      ['auto', 'scroll'].includes(c(l, `overflow-${o}`)) && ((h[r] -= l[`scroll${kt(r)}`]), (h[a] = h[r] + l[`scroll${kt(n)}`])), (h[r] += i), (h[a] -= i), h
    );
  }
  function Xs(t, e) {
  ...
  function Js(...t) {
    let e = {};
    for (const i of t) for (const [, , s, n] of rt) (e[s] = Math.max(e[s] || 0, i[s])), (e[n] = Math.min(...[e[n], i[n]].filter(Boolean)));
    return e;
  }
  function si(t, e, i) {
    const [, , s, n] = rt[i];
  ...
  function er(t, e, { offset: i, attach: s }, n) {
    return Ys(t, e, { attach: { element: Ks(s.element, n), target: Ks(s.target, n) }, offset: sr(i, n) });
  }
  function ir(t, e, i) {
    return Vs(t, e, {
      ...i,
      attach: { element: i.attach.element.map(Zs).reverse(), target: i.attach.target.map(Zs).reverse() },
  ...
  function or(t) {
    ...
    (t.use = function (n) {
      ...
      (t.extend = function (n) {
        ...
        return (
          (r.prototype = Object.create(o.prototype)), (r.prototype.constructor = r), (r.options = le(o.options, n)), (r.super = o), (r.extend = o.extend), r
        );
      }),
  ...
  function rr(t) {
    ...
    function e(s) {
      for (const { read: n, write: o, events: r = [] } of this.$options.update) {
        ...
        let a;
        n && ((a = n.call(this, this._data, s)), a && bt(a) && $t(this._data, a)),
          o &&
            a !== !1 &&
            G.write(() => {
  ...
  function ni(t, e, i) {
    ...
    !n || (h && !h.call(t)) || t._events.push(S(n, s, l ? (D(l) ? l : l.call(t)) : null, D(o) ? t[o] : o.bind(t), { passive: a, capture: r, self: u }));
  }
  function hr(t, e) {
  ...
  function fr(t) {
    ...
    return h.observe(r, { attributes: !0, attributeFilter: l.concat(l.map(u => `data-${u}`)) }), h;
  }
  function pr(t) {
    const e = t.data;
    ...
    (t.component = function (s, n) {
      ...
      (s = ge(s)),
        (t[s] = function (a, l) {
          ...
          return h.options.functional ? new h({ data: bt(a) ? a : [...arguments] }) : a ? N(a).map(u)[0] : u();
          function u(d) {
  ...
  function mr(t) {
    ...
    requestAnimationFrame(function () {
      m(document, 'uikit:init', t),
        ...
        new MutationObserver(o => o.forEach(s)).observe(document, { childList: !0, subtree: !0 }),
        new MutationObserver(o => o.forEach(n)).observe(document, { attributes: !0, subtree: !0 }),
        (t._initialized = !0);
    });
        ...
        lazyload(t = this.$el, e = this.$el) {
          this.registerObserver(
            ae(t, (i, s) => {
              ...
              for (const n of i.filter(({ isIntersecting: o }) => o).map(({ target: o }) => o)) s.unobserve(n);
            })
          );
        },
      },
    ...
    At = {
      ...
      methods: {
        ...
        _toggle(t, e) {
          ...
          let i;
          this.cls
            ? ((i = p(this.cls, ' ') || e !== A(t, this.cls)), i && R(t, this.cls, p(this.cls, ' ') ? void 0 : e))
            : ((i = e === t.hidden), i && (t.hidden = !e)),
            N('[autofocus]', t).some(s => (j(s) ? s.focus() || !0 : s.blur())),
  ...
  async function wr(t, e, { animation: i, duration: s, velocity: n, transition: o, _toggle: r }) {
    ...
    const jl = Object.fromEntries(
        ['padding', 'border', 'width', 'height', 'minWidth', 'minHeight', 'overflowY', 'overflowX', M, O].map(mo => [mo, t.style[mo]])
      ),
      Ne = w(t),
      ps = $(c(t, M)),
      fo = $(c(t, O)),
    ...
    c(ki, {
      ...
      c(t, { padding: 0, border: 0, minWidth: 0, minHeight: 0, [O]: 0, width: Ne.width, height: Ne.height, overflow: 'hidden', [k]: Ot });
    const po = Ot / Yt;
    s = (n * Yt + s) * (e ? 1 - po : po);
    const go = { [k]: e ? Yt : 0 };
    f && (c(t, M, Yt - Ot + ps), (go[M] = e ? ps : Yt + ps)), !f ^ (l === 'reveal') && (c(ki, M, -Yt + Ot), T.start(ki, { [M]: e ? 0 : -Yt }, s, o));
    try {
  ...
  async function br(t, e, { content: i, duration: s, velocity: n, transition: o }) {
    var r;
    ...
    const h = Dt(['marginTop', 'marginBottom'], d => c(i, d)) + w(i).height,
      u = l / h;
    (s = (n * h + s) * (e ? 1 - u : u)), c(a, 'height', l), await T.start(a, { height: e ? h : 0 }, s, o), ke(i), delete t._wrapper, e || oi(i, !0);
  }
  function xr(t) {
    const [e] = ct(t, !0);
    let i;
  ...
  function kr(t, e, { duration: i, transition: s, velocity: n }) {
    ...
    return (
      c(t, 'height', o),
      T.start(t, { height: 0, marginTop: 0, marginBottom: 0, paddingTop: 0, paddingBottom: 0, borderTop: 0, borderBottom: 0, opacity: 0 }, n * o + i, s)
    );
  }
  var en = {
      args: 'autoplay',
      ...
      connected() {
        (this.inView = this.autoplay === 'inview'),
          ...
          ht(this.$el, 'iframe') && !It(this.$el, 'allow') && (this.$el.allow = 'autoplay'),
          this.automute && Ns(this.$el),
          this.registerObserver(ae(this.$el, () => this.$emit(), {}, !1));
      },
      update: {
        read({ visible: t }) {
          return Hs(this.$el) ? { prev: t, visible: j(this.$el) && c(this.$el, 'visibility') !== 'hidden', inView: this.inView && Xi(this.$el) } : !1;
        },
  ...
  var ce = {
    ...
    nn = {
      ...
      data: { pos: `bottom-${Y ? 'right' : 'left'}`, offset: !1, flip: !0, shift: !0, inset: !1 },
      connected() {
      ...
      methods: {
        positionAt(t, e, i) {
          ...
          const n = [this.flip && 'flip', this.shift && 'shift'],
            o = { element: [this.inset ? this.dir : Qe(this.dir), this.align], target: [this.dir, this.align] };
          if (this.axis === 'y') {
          ...
          c(t, { top: -h.height, left: -h.width }),
            qs(t, e, { attach: o, offset: s, boundary: i, placement: n, viewportOffset: this.getViewportOffset(t) }),
            (r.scrollTop = a),
            (r.scrollLeft = l);
        },
        getPositionOffset(t) {
          return (
            nt(this.offset === !1 ? c(t, '--bdt-position-offset') : this.offset, this.axis === 'x' ? 'width' : 'height', t) *
        ...
        getShiftOffset(t) {
          return this.align === 'center'
            ? 0
            : nt(c(t, '--bdt-position-shift-offset'), this.axis === 'y' ? 'width' : 'height', t) * (p(['left', 'top'], this.align) ? 1 : -1);
        },
        getViewportOffset(t) {
  ...
  var Qi = {
    ...
    data: { cls: 'bdt-open', escClose: !0, bgClose: !0, overlay: !0, stack: !1 },
    computed: {
      panel({ selPanel: t }, e) {
        return v(t, e);
      },
      ...
      },
      {
        ...
        handler() {
          z(
            ...
            this.overlay && (z(this.$el, 'hidden', rn(this.$el), { self: !0 }), z(this.$el, 'hidden', an(), { self: !0 })),
            this.stack && c(this.$el, 'zIndex', $(c(this.$el, 'zIndex')) + et.length),
      ...
      },
      {
        ...
        handler() {
          p(et, this) && et.splice(et.indexOf(this), 1),
            c(this.$el, 'zIndex', ''),
            et.some(t => t.clsPage === this.clsPage) || B(document.documentElement, this.clsPage);
        },
      },
    ],
    methods: {
      ...
      show() {
        return this.container && P(this.$el) !== this.container
          ? (L(this.container, this.$el), new Promise(t => requestAnimationFrame(() => this.show().then(t))))
    ...
    return new Promise((n, o) =>
      z(t, 'show hide', () => {
        ...
        const r = z(
            ...
            'transitionstart',
            () => {
              z(i, 'transitionend transitioncancel', n, { self: !0 }), clearTimeout(a);
            },
            { self: !0 }
          ),
          a = setTimeout(
  ...
  function an() {
    ...
    return (
      c(t, { overflowY: 'hidden', touchAction: 'none', paddingRight: Se(window) - t.clientWidth }),
      () => {
  ...
  var ln = {
    ...
    connected() {
      x(this.$el, this.clsDrop),
        this.toggle &&
          !this.targetEl &&
          ((this.targetEl = this.$create('toggle', lt(this.toggle, this.$el), { target: this.$el, mode: this.mode }).$el),
          b(this.targetEl, 'aria-haspopup', !0),
          this.lazyload(this.targetEl)),
        (this._style = (({ width: t, height: e }) => ({ width: t, height: e }))(this.$el.style));
    },
    disconnected() {
        ...
        handler() {
          ...
          const t = () => this.$emit(),
            e = [
              ...
              ...(this.autoUpdate ? [S([document, he(this.$el)], 'scroll', t, { passive: !0 })] : []),
    ...
    methods: {
      ...
      position() {
        ...
        for (const [n, [o, r]] of i)
          this.axis !== o && p([o, !0], this.stretch) && c(this.$el, { [r]: Math.min(_(this.boundary[n])[r], t[n][r] - 2 * e), [`overflow-${o}`]: 'auto' });
  ...
  var Pr = {
    ...
    hn = {
      ...
      connected() {
        this.registerObserver(Os(this.$el, () => this.$reset(), { childList: !0, attributes: !0, attributeFilter: ['style'] }));
      },
      update: {
        read() {
        ...
        write({ columns: t, rows: e }) {
          for (const i of e) for (const s of i) R(s, this.margin, e[0] !== i), R(s, this.firstColumn, t[0].includes(s));
        },
        events: ['resize'],
      },
    };
  ...
  function ri(t, e = !1) {
    ...
    return e && ([i, s] = Lt(t)), { top: i, left: s, bottom: i + n, right: s + o };
  }
  var ai = {
    connected() {
  ...
  let Ee;
  function un(t, e) {
    (Ee = Ee || S(window, 'scroll', () => li.forEach(i => i()), { passive: !0, capture: !0 })), li.set(t, e);
  }
  function dn(t) {
    ...
    update: [
      ...
      },
      {
        read(t) {
          ...
          return (
            l && (l = o.reduce((h, u, d) => Math.max(h, u + r + (d % 2 ? l : l / 8) - a), 0)), { padding: l, columns: e, translates: s, height: s ? a : '' }
          );
        },
      ...
      {
        read() {
          return this.parallax && fn(this.$el) ? !1 : { scrolled: this.parallax ? Ji(this.$el) * Math.abs(this.parallax) : !1 };
        },
        write({ columns: t, scrolled: e, translates: i }) {
          (e === !1 && !i) ||
            t.forEach((s, n) => s.forEach((o, r) => c(o, 'transform', !e && !i ? '' : `translateY(${(i && -i[n][r]) + (e ? (n % 2 ? e : e / 8) : 0)}px)`)));
        },
  ...
  var Mr = {
    ...
    update: {
      read() {
        return { rows: (this.row ? es(this.elements) : [this.elements]).map(Dr) };
      },
      write({ rows: t }) {
  ...
  var Nr = {
            ...
            this.offsetBottom === !0
              ...
              : Mt(this.offsetBottom)
                ...
                : this.offsetBottom && Xt(this.offsetBottom, 'px')
                  ...
                  : D(this.offsetBottom) && (e += ` - ${w(lt(this.offsetBottom, this.$el)).height}px`),
              (e += `${i ? ` - ${i}px` : ''})`);
          }
          return { minHeight: e, prev: t };
        },
        write({ minHeight: t }) {
          c(this.$el, { minHeight: t }), this.minHeight && $(c(this.$el, 'minHeight')) < this.minHeight && c(this.$el, 'minHeight', this.minHeight);
        },
        events: ['resize'],
      },
    },
    pn = {
      ...
      data: { ratio: 1, include: ['style', 'class'], class: '', strokeAnimation: !1 },
      beforeConnect() {
        this.class += ' bdt-svg';
      },
      connected() {
      ...
      methods: {
        async getSvg() {
          return ht(this.$el, 'img') && !this.$el.complete && this.$el.loading === 'lazy'
            ? new Promise(t => z(this.$el, 'load', () => t(this.getSvg())))
            : Fr(await Hr(this.src), this.icon) || Promise.reject('SVG not found.');
        },
        applyAttributes(t, e) {
  ...
  const ci = {
    ...
    la = {
      ...
      beforeConnect() {
        this.icon =
          A(this.$el, 'bdt-search-icon') && te(this.$el, '.bdt-search-large').length
            ? 'search-large'
  ...
  var ga = {
    ...
    connected() {
      ...
      (pa && di(this.$el) && ((this.$el.loading = 'lazy'), ss(this.$el), t.length === 1)) ||
        (ba(this.$el),
        this.registerObserver(
          ae(
            t,
  ...
  function Sa({ modal: t }) {
    (t.dialog = function (i, s) {
      ...
      (t.alert = function (i, s) {
        return e(
          ({ labels: n }) =>
            `<div class="bdt-modal-body">${D(i) ? i : _t(i)}</div> <div class="bdt-modal-footer bdt-text-right"> <button class="bdt-button bdt-button-primary bdt-modal-close" autofocus>${n.ok}</button> </div>`,
          s,
          n => n.resolve()
        );
      }),
      (t.confirm = function (i, s) {
        return e(
          ({ labels: n }) =>
            `<form> <div class="bdt-modal-body">${D(i) ? i : _t(i)}</div> <div class="bdt-modal-footer bdt-text-right"> <button class="bdt-button bdt-button-default bdt-modal-close" type="button">${n.cancel}</button> <button class="bdt-button bdt-button-primary" autofocus>${n.ok}</button> </div> </form>`,
          s,
          n => n.reject()
        );
      }),
      (t.prompt = function (i, s, n) {
        return e(
          ({ labels: o }) =>
            `<form class="bdt-form-stacked"> <div class="bdt-modal-body"> <label>${D(i) ? i : _t(i)}</label> <input class="bdt-input" value="${s || ''}" autofocus> </div> <div class="bdt-modal-footer bdt-text-right"> <button class="bdt-button bdt-button-default bdt-modal-close" type="button">${o.cancel}</button> <button class="bdt-button bdt-button-primary">${o.ok}</button> </div> </form>`,
          n,
          o => o.resolve(null),
  ...
  var Ta = { extends: tn, data: { targets: '> .bdt-parent', toggle: '> a', content: '> ul' } },
    Ca = {
      mixins: [tt, ce],
      props: {
        dropdown: String,
        ...
        dropdowns: {
          ...
          watch(t) {
            this.$create(
              ...
              { ...this.$props, flip: !1, shift: !0, pos: `bottom-${this.align}`, boundary: this.boundary === !0 ? this.$el : this.boundary }
            );
          },
          immediate: !0,
        },
      ...
      events: [
        ...
        },
        {
          ...
          handler(t) {
            ...
            i === qt.DOWN &&
              It(e, 'aria-expanded') &&
              (t.preventDefault(), !s || s.targetEl !== e ? (e.click(), z(this.dropContainer, 'show', ({ target: n }) => yn(n))) : yn(s.$el)),
              xn(t, this.toggles, s);
          },
        },
        {
          ...
          handler(t) {
            ...
            if (
              ...
              i === qt.DOWN && (t.preventDefault(), o < n.length - 1 && n[o + 1].focus()),
              i === qt.ESC)
            ) {
              var r;
        ...
        },
        {
          ...
          handler({ target: t }) {
            this.isDropbarDrop(t) &&
              (this.dropbar.previousElementSibling !== this.dropbarAnchor && Xe(this.dropbarAnchor, this.dropbar), x(t, `${this.clsDrop}-dropbar`));
          },
        },
        {
          name: 'show',
      ...
      methods: {
        ...
        transitionTo(t, e) {
          ...
          (e = s < t && e),
            ...
            Z(i, s),
            T.cancel([e, i]),
            Promise.all([T.start(i, { height: t }, this.duration), T.start(e, { clipPath: `polygon(0 0,100% 0,100% ${t}px,0 ${t}px)` }, this.duration)])
              .catch(C)
              .then(() => c(e, { clipPath: '' }));
        },
        getDropdown(t) {
  ...
  function xn(t, e, i) {
    ...
    n === qt.LEFT && r > 0 && (i.hide == null || i.hide(!1), e[r - 1].focus()),
      n === qt.RIGHT && r < e.length - 1 && (i.hide == null || i.hide(!1), e[r + 1].focus()),
        ...
        ni(this, {
          ...
          handler(t) {
            ...
            z(document, `${Pt} ${ti} scroll`, s => {
              const { x: n, y: o } = ie(s);
              ((s.type !== 'scroll' && i && n && Math.abs(e.x - n) > 100) || (o && Math.abs(e.y - o) > 100)) &&
                setTimeout(() => {
  ...
  var Aa = {
    ...
    Oa = {
      ...
      update: {
        read() {
          return j(this.$el) && this.width && this.height ? { width: Se(P(this.$el)), height: this.height } : !1;
        },
        write(t) {
          Z(this.$el, Re.contain({ height: this.height, width: this.width }, t).height);
        },
        events: ['resize'],
      },
    },
      ...
      methods: {
        async scrollTo(t) {
          (t = (t && v(t)) || document.body),
            m(this.$el, 'beforescroll', [this, t]) && (await Rs(t, { offset: this.offset }), m(this.$el, 'scrolled', [this, t]));
        },
      },
    };
  const Ae = new Set();
  ...
  function Tn(t) {
    if (!t.defaultPrevented) for (const e of Ae) I(t.target, e.$el) && Cn(e.$el) && (t.preventDefault(), e.scrollTo(In(e.$el)));
  }
  function Cn(t) {
  ...
  var za = {
      ...
      data: () => ({ cls: '', target: !1, hidden: !0, margin: '-1px', repeat: !1, delay: 0, inViewClass: 'bdt-scrollspy-inview' }),
      computed: {
        elements: {
          get({ target: t }, e) {
            return t ? N(t, e) : [e];
            ...
            ae(
              ...
              t => {
                ...
                for (const { target: i, isIntersecting: s } of t) {
                  e.has(i) || e.set(i, { cls: it(i, 'bdt-scrollspy-class') || this.cls });
                  const n = e.get(i);
      ...
      methods: {
        toggle(t, e) {
          ...
          if (i) {
            if (
              (i.off == null || i.off(), c(t, 'opacity', !e && this.hidden ? 0 : ''), R(t, this.inViewClass, e), R(t, i.cls), /\bbdt-animation-/.test(i.cls))
            ) {
    ...
    Ha = {
      ...
      connected() {
        (this.start = _n(this.start || this.top)),
          ...
          (this.placeholder = v('+ .bdt-sticky-placeholder', this.$el) || v('<div class="bdt-sticky-placeholder"></div>')),
          (this.isFixed = !1),
          this.setActive(!1),
          this.registerObserver(Ce(this.$el, () => !this.isFixed && this.$emit('resize')));
      },
      disconnected() {
          ...
          handler() {
            ...
            !location.hash ||
              ...
              setTimeout(() => {
                ...
                this.isFixed &&
                  Pi(e, i) &&
                  (t.scrollTop = e.top - i.height - nt(this.targetOffset, 'height', this.placeholder) - nt(this.offset, 'height', this.placeholder));
              });
          },
        },
      ],
      update: [
        {
          read({ height: t, width: e, margin: i, sticky: s }, n) {
            ...
            o && (c(this.selTarget, 'transition', '0s'), this.hide()),
              this.active || (({ height: t, width: e } = _(this.$el)), (i = c(this.$el, 'margin'))),
              o && (this.show(), requestAnimationFrame(() => c(this.selTarget, 'transition', '')));
            ...
            return (
              (s = l && !this.showOnUp && M + d === g && O === Math.min(l, ns('!*', this.$el, 0, !0) - k - d + f) && c(P(this.$el), 'overflowY') === 'visible'),
              { start: M, end: O, offset: d, overflow: f, topOffset: g, height: t, elHeight: k, width: e, margin: i, top: Lt(u)[0], sticky: s }
            );
          },
          write({ height: t, width: e, margin: i, offset: s, sticky: n }) {
            ...
            c(o, { height: t, width: e, margin: i }), I(o, document) || (o.hidden = !0), (n ? Ge : Xe)(this.$el, o);
          },
        ...
        },
        {
          ...
          write(t, e) {
            ...
            const f = Date.now();
            if (
              ((f - s > 300 || n !== o) && ((t.initScroll = r), (t.initTimestamp = f)),
              ...
              if (this.inactive || r < h || (this.showOnUp && (r <= h || (n === 'down' && i) || (n === 'up' && !this.isFixed && r <= u + d)))) {
                ...
                this.isFixed
                  ? this.update()
                  : this.animation && r > u
                    ? (pt.cancel(this.$el), this.show(), pt.in(this.$el, this.animation).catch(C))
                    : this.show();
          },
      ...
      methods: {
        ...
        hide() {
          ...
          this.setActive(!1),
            ...
            e ? c(this.$el, 'top', t) : c(this.$el, { position: '', top: '', width: '', marginTop: '' }),
        ...
        update() {
          ...
          if (!d) {
            let g = 'fixed';
            e > o && ((r += o - u), (g = 'absolute')), c(this.$el, { position: g, width: t }), c(this.$el, 'marginTop', 0, 'important');
          }
        ...
        setActive(t) {
          ...
          (this.active = t),
            t
              ? (Fi(this.selTarget, this.clsInactive, this.clsActive), e !== t && m(this.$el, 'active'))
              : (Fi(this.selTarget, this.clsActive, this.clsInactive), e !== t && m(this.$el, 'inactive'));
        },
      },
    };
  function ns(t, e, i, s) {
  ...
  var En = {
      ...
      data: { connect: '~.bdt-switcher', toggle: '> * > :first-child', itemNav: !1, active: 0, cls: 'bdt-active', attrItem: 'bdt-switcher-item' },
      computed: {
        connects: {
          get({ connect: t }, e) {
            return be(t, e);
        ...
        },
        {
          ...
          handler(t) {
            ...
            (this._preventClick ||
              ...
              ((e = Q(t.target, 'a[href]')) && (b(this.$el, 'aria-expanded') !== 'true' || (e.hash && H(this.target, e.hash))))) &&
              t.preventDefault(),
      ...
      update() {
        ...
        for (const e of ja) {
          ...
          (s = s.length < 2 ? `0${s}` : s),
            i.textContent !== s &&
              ((s = s.split('')),
              s.length !== i.children.length && _t(i, s.map(() => '<span></span>').join('')),
  ...
  function An(t, e, i, s = 0) {
    const n = pi(e, !0),
      ...
      h = a(async () => {
        ...
        u !== f && k.push(T.start(e, { height: f }, i / 2 + g.length * s, 'ease')),
          await Promise.all(k).then(() => {
            B(e, rs), n === pi(e) && (c(e, { height: '', alignContent: '' }), c(d, { opacity: '' }), delete e.dataset.transition);
          });
      });
  ...
  function On(t) {
    return Promise.all(
      E(t)
        .filter(T.inProgress)
        .map(e => new Promise(i => z(e, 'transitionend transitioncanceled', i)))
    );
  }
  function Bn(t) {
  ...
  function Mn(t, e) {
    const i = c(t, 'zIndex');
    return j(t)
      ? { display: '', opacity: e ? c(t, 'opacity') : '0', pointerEvents: 'none', position: 'absolute', zIndex: i === 'auto' ? ee(t) : i, ...Dn(t) }
      : !1;
  }
  function Ja(t, e, i) {
    const s = e.map((o, r) => (P(o) && r in i ? (i[r] ? (j(o) ? Dn(o) : { opacity: 0 }) : { opacity: j(o) ? 1 : 0 }) : !1)),
      n = s.map((o, r) => {
  ...
  var Nn = {
    ...
    Za = {
      ...
      data: { target: null, selActive: !1, attrItem: 'bdt-filter-control', cls: 'bdt-active', duration: 250 },
      computed: {
        toggles: {
          get({ attrItem: t }, e) {
            return N(`[${t}],[data-${t}]`, e);
      ...
      methods: {
        ...
        getState() {
          return this.toggles.filter(t => A(t, this.cls)).reduce((t, e) => Fn(e, this.attrItem, t), { filter: { '': '' }, sort: [] });
        },
        async setState(t, e = !0) {
          (t = { filter: { '': '' }, sort: [], ...t }),
            m(this.$el, 'beforeFilter', [this, t]),
            this.toggles.forEach(i => R(i, this.cls, !!tl(i, this.attrItem, t))),
            await Promise.all(
      ...
      (s || q(o)) &&
        (n
          ? s
            ...
            : (delete i.filter[n], (me(i.filter) || '' in i.filter) && (i.filter = { '': s || '' }))
          : (i.filter = { '': s || '' })),
      q(o) || (i.sort = [o, r]),
      i
    );
  ...
  function sl(t, e, i) {
    return [...t].sort((s, n) => it(s, e).localeCompare(it(n, e), void 0, { numeric: !0 }) * (i === 'asc' || -1));
  }
  var as = {
    slide: {
      show(t) {
  ...
  function nl(t, e, i, { animation: s, easing: n }) {
    ...
    return {
      ...
      translate(u) {
        this.reset();
        const d = r(u, i);
        c(e, d[1]), c(t, d[0]), gi(e, 'itemtranslatein', { percent: u, dir: i }), gi(t, 'itemtranslateout', { percent: 1 - u, dir: i });
      },
      percent() {
        return o(t || e, e, i);
      },
  ...
  var ol = {
    ...
    methods: {
      startAutoplay() {
        this.stopAutoplay(),
          (this.interval = setInterval(
            () => (!this.draggable || !v(':focus', this.$el)) && (!this.pauseOnHover || !H(this.$el, ':hover')) && !this.stack.length && this.show('next'),
    ...
    methods: {
      ...
      move(t) {
        ...
        [this.index, this.prevIndex]
          ...
          h && ((this.prevIndex = s), (this.index = o), !u && m(a, 'beforeitemhide', [this]), m(l, 'beforeitemshow', [this])),
      ...
      update: {
        write() {
          this.nav &&
            ...
            _t(this.nav, this.slides.map((t, e) => `<li ${this.attrItem}="${e}"><a href></a></li>`).join('')),
  ...
  var Vn = {
      ...
      data: { animation: 'slide', clsActivated: 'bdt-transition-active', Animations: as, Transitioner: nl },
      computed: {
      ...
      events: [
        ...
        },
        {
          ...
          async handler(t, e) {
            ...
            let a;
            const l = { allowfullscreen: '', style: 'max-width: 100%; box-sizing: border-box;', 'bdt-responsive': '', 'bdt-video': `${this.videoAutoplay}` };
            if (s === 'image' || i.match(/\.(avif|jpe?g|jfif|a?png|gif|svg|webp)($|\?)/i))
              try {
                const { width: h, height: u } = await ks(i, r.srcset, r.size);
                this.setItem(e, Be('img', { src: i, width: h, height: u, alt: n, ...r }));
              } catch {
                this.setError(e);
              }
            else if (s === 'video' || i.match(/\.(mp4|webm|ogv)($|\?)/i)) {
              const h = Be('video', { src: i, poster: o, controls: '', playsinline: '', 'bdt-video': `${this.videoAutoplay}` });
              S(h, 'loadedmetadata', () => {
                b(h, { width: h.videoWidth, height: h.videoHeight, ...r }), this.setItem(e, h);
              }),
                S(h, 'error', () => this.setError(e));
            } else if (s === 'iframe' || i.match(/\.(html|php)($|\?)/i))
              this.setItem(e, Be('iframe', { src: i, allowfullscreen: '', class: 'bdt-lightbox-iframe', ...r }));
            else if ((a = i.match(/\/\/(?:.*?youtube(-nocookie)?\..*?[?&]v=|youtu\.be\/)([\w-]{11})[&?]?(.*)?/)))
              this.setItem(
                e,
                Be('iframe', { src: `https://www.youtube${a[1] || ''}.com/embed/${a[2]}${a[3] ? `?${a[3]}` : ''}`, width: 1920, height: 1080, ...l, ...r })
              );
            else if ((a = i.match(/\/\/.*?vimeo\.[a-z]+\/(\d+)[&?]?(.*)?/)))
              try {
                const { height: h, width: u } = await (
                  await fetch(`https://vimeo.com/api/oembed.json?maxwidth=1920&url=${encodeURI(i)}`, { credentials: 'omit' })
                ).json();
                this.setItem(e, Be('iframe', { src: `https://player.vimeo.com/video/${a[1]}${a[2] ? `?${a[2]}` : ''}`, width: u, height: h, ...l, ...r }));
              } catch {
                this.setError(e);
              }
          },
  ...
  var fl = {
    ...
    created() {
      const t =
        ...
        L(this.container, `<div class="${this.clsContainer} ${this.clsContainer}-${this.pos}" style="display: block"></div>`);
      this.$mount(
        L(
          t,
  ...
  function vi(t, e, i) {
    ...
    return (
      t === 'x' || t === 'y'
        ? ((t = `translate${kt(t)}`), (n = o => $($(o).toFixed(s === 'px' ? 0 : 6))))
        : t === 'scale' && ((s = ''), (n = o => ($i([o]) ? nt(o, 'width', e, !0) / e.offsetWidth : o))),
  ...
  function de(t, e = $) {
    ...
    for (let o = 0; o < s; o++) {
      ...
      if (
        ((r = e(r)),
        (a = a ? $(a) / 100 : null),
        o === 0 ? (a === null ? (a = 0) : a && i.push([r, 0])) : o === s - 1 && (a === null ? (a = 1) : a !== 1 && (i.push([r, a]), (a = 1))),
        i.push([r, a]),
        a === null)
      )
        n++;
  ...
  var xl = {
    ...
    update: {
      read({ percent: t }, e) {
        ...
        const i = t;
        return (t = yl(Ji(this.target, this.start, this.end), this.easing)), { percent: t, style: i === t ? !1 : this.getCss(t) };
      },
      write({ style: t }) {
        if (!this.matchMedia) {
          this.reset();
    ...
    return {
      ...
      show(h, u = 0, d) {
        ...
        return (
          ...
          this.translate(u),
          (u = t ? u : K(u, 0, 1)),
          ds(this.getItemIn(), 'itemin', { percent: u, duration: h, timing: f, dir: i }),
          t && ds(this.getItemIn(!0), 'itemout', { percent: 1 - u, duration: h, timing: f, dir: i }),
          T.start(o, { transform: F(-l * (Y ? -1 : 1), 'px') }, h, f).then(r.resolve, C),
          r.promise
        );
      },
      cancel() {
      ...
      translate(h) {
        ...
        for (const k of E(o)) {
          ...
          ds(k, `itemtranslate${fs ? 'in' : 'out'}`, { dir: i, percent: Ot ? 1 - h : O ? h : M ? 1 : 0 });
        }
      },
      percent() {
    ...
    computed: {
      ...
      sets({ sets: t }) {
        ...
        for (let n = 0; n < this.length; n++) {
          ...
          e + o > s && (e = 0),
            this.center
              ? e < s / 2 && e + o + w(this.slides[+n + 1]).width / 2 > s / 2 && (i.push(+n), (e = s / 2 - o / 2))
    ...
    El = {
      ...
      computed: {
        ...
        handles: {
          ...
          watch(t, e) {
            c(e, { touchAction: '', userSelect: '' }), c(t, { touchAction: Rt ? 'none' : '', userSelect: 'none' });
          },
          immediate: !0,
        },
      },
      ...
      methods: {
        ...
        start(t) {
          ...
          $t(this.origin, { offsetLeft: this.pos.x - e, offsetTop: this.pos.y - i }),
        ...
        move(t) {
          ...
          this === t
            ? this.origin.index !== ee(this.placeholder) && m(this.$el, 'moved', [this, this.placeholder])
            : (m(t.$el, 'added', [t, this.placeholder]), m(this.$el, 'removed', [this, this.placeholder])),
            m(this.$el, 'stop', [this, this.placeholder]),
            st(this.drag),
            (this.drag = null);
          for (const { clsPlaceholder: e, clsItem: i } of this.touched) for (const s of this.touched) B(s.items, e, i);
  ...
  function Bl(t, e) {
    ...
    return (
      ...
      c(i, { boxSizing: 'border-box', width: e.offsetWidth, height: e.offsetHeight, padding: c(e, 'padding') }),
  ...
  var Nl = {
    ...
    beforeConnect() {
      (this.id = `bdt-tooltip-${this._uid}`), (this._hasTitle = It(this.$el, 'title')), b(this.$el, { title: '', 'aria-describedby': this.id }), Hl(this.$el);
    },
    disconnected() {
    ...
    methods: {
      show() {
        this.isToggled(this.tooltip || null) ||
          ...
          ((this._unbind = z(
            ...
            this.hide,
            !1,
            t => (t.type === gt && !I(t.target, this.$el)) || (t.type === 'keydown' && t.keyCode === 27)
          )),
      ...
      async hide() {
        H(this.$el, 'input:focus') ||
          (clearTimeout(this.showTimer),
          this.isToggled(this.tooltip || null) && (await this.toggleElement(this.tooltip, !1, !1), st(this.tooltip), (this.tooltip = null), this._unbind()));
      },
      _show() {
        const [t] = ct(this.$el);
        (this.tooltip = L(
